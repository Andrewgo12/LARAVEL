							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
										...
										<ul>
											<li><div style="font-family: serif;font-weight: 800">Nombre de usuario : </div>: <?php echo  $usuario->username;?></li>
											<li><div style="font-family: serif;font-weight: 800">Email</div>: <?php echo  $usuario->email;?></li>
											<li><div style="font-family: serif;font-weight: 800">Contraseña</div>: <?php echo  $password;?></li>
											<li><div style="font-family: serif;font-weight: 800">centro de costo: </div>: <?php echo  $usuario->centro;?></li>
											<li><h3><a href='<?php echo base_url();?>Cauth/activate/<?php echo $usuario->id ?>/<?php echo $usuario->code ?>'>Activar Cuenta</a></h3></li>
										</ul>
