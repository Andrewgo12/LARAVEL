					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								...
								<form action="<?php echo base_url();?>equipo/Cequipos/addEquipoContacto" id="form_equipo_contacto" name="form_equipo_contacto" enctype="multipart/form-data" method="post">
									<br>
