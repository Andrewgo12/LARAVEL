  ...
  <table cellpadding=0 cellspacing=0 width=832 class="tabla_detalles" style='border-collapse:
    ...
    <tr height=24 style='height:18.0pt'>
      ...
      <td colspan=17 rowspan=12 class=xl9626419 width=309 style='border-right:1.0pt solid black;
						border-bottom:1.0pt solid black;width:234pt'>&nbsp;<img class="" width="350px" height="280px" src="<?php echo base_url(); ?>assets/upload_imagenes/<?php echo $equipo->image; ?>" alt=""></td>
      <td class=xl1526419></td>
    </tr>
    ...
    <tr height=21 style='height:15.75pt'>
      ...
      <td colspan=35 class=xl13626419 width=361 style='border-right:1.0pt solid black;
        ...
        <?php if ($equipo->registro_sanitario != null) : ?>
          ...
          <a target="__blank" class="glyphicon glyphicon-file esconder" href="<?php echo base_url(); ?>assets/upload_registros_sanitarios/<?php echo $equipo->file_registro_sanitario; ?>"></a>
        <?php else : ?>
    ...
    <tr height=21 style='height:15.75pt'>
      ...
      <td colspan=35 class=xl6926419 width=361 style='border-right:1.0pt solid black;
        ...
        <?php if ($equipo->area != "" && $equipo->area != null) : ?>
          <strong>Area:</strong>
    ...
    <tr height=22 style='height:16.5pt'>
      ...
      <td colspan=28 class=xl11726419 width=272 style='border-right:1.0pt solid black;
        ...
        <?php if ($equipo->orden_compra_id != "" && $equipo->orden_compra_id != null) : ?>
          ||
          <?php if ($equipo->tipo_compra_id == 1) : ?>
          ...
          <?php if ($equipo->file_orden_compra != null && $equipo->file_orden_compra != "") : ?>
            <a class="glyphicon glyphicon-file esconder" href="<?php echo base_url(); ?>assets/upload_ordenes_compra/<?php echo $equipo->file_orden_compra; ?>" target="__blank"></a>
          <?php endif ?>
        <?php endif ?>
    ...
    <tr height=21 style='height:15.75pt'>
      <td colspan=54 height=21 class=xl13026419 width=752 style='border-right:1.0pt solid black;
        ...
        <?php if (isset($archivo)) : ?>
          <ul>
            <?php foreach ($archivo as $archivo_row) : ?>
              <li>Archivo: <?php echo $archivo_row->file; ?> <a style="color: #222d32;font-size:15px;font-weight:900;" href="<?php echo base_url(); ?>assets/upload_archivos/<?php echo $archivo_row->file; ?>" onclick="window.open(this.href, 'mywin',
    ...
    <tr height=22 style='height:16.5pt'>
      ...
      <td colspan=13 class=xl17526419 width=128 style='width:99pt'>&nbsp;<?php echo $frecuency_computed; ?></td>
    ...
    <tr height=21 style='height:15.75pt'>
      <td colspan=54 height=21 class=xl12726419 width=752 style='border-right:1.0pt solid black;
        ...
        <div class="row row-owner">
          ...
          <div class="col-sm-4">
            <img class="img-responsive" src="<?php echo base_url(); ?>assets/upload_imagenes/<?php echo $equipo->propietario_logo; ?>" alt="Logo del propietario">
          </div>
          <?php if ($equipo->baja_id != 0) : ?>
            <div class="col-sm-4">
              <h5><u>Este equipo ha sido relacionado a inventaio para su correspondiente disposición final</u></h4>
                ...
                <a class="fa fa-paperclip" target="__blank" href="<?php echo base_url(); ?>assets/upload_bajas/<?php echo $equipo->baja_documento; ?>"></a>
            </div>
          <?php endif ?>
        </div>
      </td>
          ...
          <?php if (isset($observaciones)) : ?>
            ...
            <?php foreach ($observaciones as $observacion_row) : ?>
              ...
              <?php else : ?>
                ...
                <?php if ($observacion_row->repuesto_id != null && $observacion_row->repuesto_id != NULL && $observacion_row->repuesto_id != "" && $observacion_row->repuesto_pendiente == "si") : ?>
                  <span class="glyphicon glyphicon-wrench text-danger" title="Repuesto pendiente"><?php echo $observacion_row->repuesto_id; ?></span>
                <?php endif ?>
                <p></p>
              <?php endif ?>
