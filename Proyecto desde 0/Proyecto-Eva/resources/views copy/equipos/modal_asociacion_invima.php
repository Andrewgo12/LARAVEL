<div class="modal fade" id="modal_asociacion_invima">
  <div class="modal-dialog" style="width:90%;">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="" class="form_asociacion_invima_equipos" id="form_asociacion_invima_equipos" name="form_asociacion_invima_equipos" enctype="multipart/form-data" method="post">
