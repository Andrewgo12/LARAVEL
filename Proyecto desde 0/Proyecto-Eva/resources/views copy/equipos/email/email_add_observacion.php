                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="600"
                    ...
                    <tr>
                        <td align="center" bgcolor="#70bbd9"
                            ...
                            <img src="http://asamblea.valledelcauca.gov.co/info/asamblea/media/pub43460.jpg" width="300"
                                height="230" style="display: block;" alt="Logo Asamblea" />
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td
                                        ...
                                        <h2><b>Correctivo general Nro {{ $correctivo_general->id }}</b></h2>
                                    </td>
                                </tr>
                                <tr>
                                    <td
                                        ...
                                        <h4>Código de orden de trabajo:&nbsp;</h4>{{ $correctivo_general->code_orden }}

                                        <blockquote>
                                            <h4>Descripción</h4>
                                            <p>{{ $correctivo_general->orden }}</p>
                                            <footer style="font-size: 10px;">
                                                <strong>Fecha de registro</strong>: {{ $correctivo_general->fecha_inicio }}
                                            </footer>
                                        </blockquote>
                                        ...
                                        <blockquote>
                                            ...
                                            @if (!empty($equipo->area) && $equipo->area !== 'null')
                                            <footer style="font-size: 10px;">
                                        ...
                                        <ul>
                                            <li style="font-size: 15px">
                                                <strong>Id del equipo en el sistema:</strong> {{ $equipo->id }}
                                            </li>
                                            <li style="font-size: 15px">
                                                <strong>Nombre del equipo:</strong> {{ $equipo->name }}
                                            </li>
                                            <li style="font-size: 15px">
                                                <strong>Marca del equipo:</strong> {{ $equipo->marca }}
                                            </li>
                                            <li style="font-size: 15px">
                                                <strong>Modelo del equipo:</strong> {{ $equipo->modelo }}
                                            </li>
                                            <li style="font-size: 15px">
                                                <strong>Activo fijo del equipo:</strong> {{ $equipo->code }}
                                            </li>
                                            <li style="font-size: 15px">
                                                <strong>Serie del equipo:</strong> {{ $equipo->serial }}
                                            </li>
                                        </ul>
                                        @endif
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="color: #ffffff; font-family: Arial, sans-serif; font-size: 14px;"
                                        ...
                                        <a href="#" style="color: #ffffff;">Hospital Universitario del Valle</a>
                                    </td>
