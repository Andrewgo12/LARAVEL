					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								...
								<form action="<?php echo base_url();?>equipo/Cequipos/updateCalibracion" id="form_update_calibracion" name="form_update_calibracion" enctype="multipart/form-data" method="post">
									<br>
