					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								...
								<form action="<?php echo base_url();?>equipos/Cequipos/updateEquipoRepuesto" id="form_update_equipo_repuesto" name="form_update_equipo_repuesto" enctype="multipart/form-data" method="post">
									<br>
									...
									<div class="box-footer">
										<button class="btn btn-primary" id="btn_update_equipo_repuesto">Actualizar</button>
									</div>
