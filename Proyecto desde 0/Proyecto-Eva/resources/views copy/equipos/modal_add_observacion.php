					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								...
								<form action="<?php echo base_url();?>equipo/Cequipos/addObservacion" id="form_observacion" name="form_observacion" enctype="multipart/form-data" method="post">
									<br>
									<input type="hidden" name="equipo_id" id="equipo_id">
									<input type="hidden" name="usuario_id" id="usuario_id" value="<?php echo $this->session->userdata("id");?>">
