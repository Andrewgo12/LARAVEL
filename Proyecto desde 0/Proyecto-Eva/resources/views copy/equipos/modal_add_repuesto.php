<div id="modal_add_repuesto" class="modal fade" role="dialog">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="box box-info">
							...
							<form action="<?php echo base_url(); ?>equipo/Cequipos/addEquipoRepuesto" id="form_repuesto" name="form_repuesto" enctype="multipart/form-data" method="post">
								<br>
								...
								<div class="row">
									...
									?>
									<div class="col-sm-4">
										<input type="date" name="fecha" id="fecha" required="" min="2015-01-01" max="<?php echo $fecha_superior; ?>">
									</div>
								...
								<div class="box-footer">
									<button class="btn btn-primary" id="btn_add_repuesto">Ingresar</button>
								</div>
