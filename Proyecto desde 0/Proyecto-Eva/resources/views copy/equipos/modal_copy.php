					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								...
								<form action="<?php echo base_url(); ?>equipo/Cequipos/add" id="form_equipo_copy" name="form_equipo_copy" enctype="multipart/form-data" method="post">


									<input type="hidden" id="id" name="id" class="form-control">
									<input type="hidden" id="tipo_id" name="tipo_id" class="form-control" value="<?php echo $tipo_id; ?>">
									<br>
