...
<link rel="stylesheet" href="{{ asset('') }}css/login/login.css?n=<?= time(); ?>">
...
<div class="container">
  ...
  <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
    ...
    <div class="row">
      ...
      <img class="img-responsive" src="<?= base_url(); ?>assets/template/6.jpg?n=<?= time(); ?>" alt="">
    </div>
...
<script src="{{ asset('') }}js/login.js?n=<?= time(); ?>"></script>