					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								...
								<form action="{{ asset('') }}orden/Cordenes/update_solicitar_cierre_orden" id="form_solicitar_cierre_orden" name="form_solicitar_cierre_orden" class="form_solicitar_cierre_orden" enctype="multipart/form-data" method="post">
      @csrf
