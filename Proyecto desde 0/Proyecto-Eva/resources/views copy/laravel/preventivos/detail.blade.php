<div class="" style="overflow-x: auto;">
	...
	<div class="tab-content">
		<div id="listado" class="tab-pane fade in active">
			...
			<a class="btn btn-info" href="{{ asset('') }}preventivo/Cpreventivos/ExportarExcel" target="_blank">Exportar listado</a><br><br>
			<div class="row">
				<div class="col-sm-12">
							...
							@foreach($preventivos as $preventivo)
								<tr>
									...
									@if($preventivo->archivo!=""&&$preventivo->archivo!=null)
										<td><?php echo "<a target='__blank' class='glyphicon glyphicon-file' href='".{{ asset('assets/upload_preventivos/') }}.$preventivo->archivo."'></a>"; ?></td>
										@else
											<td></td>
										<?php endif ?>
			...
			<div id="exportar" class="tab-pane fade">
				<div class="row">
					<div class="col-sm-4">
						...
						<form action="<?php echo base_url() ?>Zip/files" target="__blank" method="post" enctype="multipart/form-data">
