...
@section('title', 'Contacts & Providers')
            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 table-responsive editarContacto">
                        <form action="{{ url('ubicacion/contactos/update') }}" id="form_contacto" name="form_contacto" enctype="multipart/form-data" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <label for="tcontacto_id">Tipo de contacto:</label>
                                </div>
                                <div class="col-sm-9">
                                    <select required name="tcontacto_id" id="tcontacto_id" class="form-control">
                            ...
                            <div class="box-footer">
                                <button type="button" class="btn btn-primary" id="btn_update_contacto" onclick="aplicar_condicion(1)" disabled>Actualizar</button>
                                <button type="button" class="btn btn-info fa fa-plus btn-flat" id="btn_add_contacto" onclick="aplicar_condicion(2)">Agregar</button>
                            </div>
