					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								...
								<form action="<?php echo base_url();?>equipos_ind/Cequipos_ind/addCalibracion" id="form_calibracion" name="form_calibracion" enctype="multipart/form-data" method="post">
									<br>
