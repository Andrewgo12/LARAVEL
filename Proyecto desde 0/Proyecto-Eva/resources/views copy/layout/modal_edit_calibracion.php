<div id="modal_update_calibracion" class="modal fade" role="dialog">
					...
					<div class="col-md-12">
						<div class="box box-info">
							<div class="box-header with-border">
								<h3 class="box-title">Calibracion
								</h3>
							</div>
							...
							<div class="box-body form-horizontal">
								...
								<form action="<?php echo base_url();?>equipos_ind/Cequipos_ind/updateCalibracion" id="form_update_calibracion" name="form_update_calibracion" enctype="multipart/form-data" method="post">
									<br>
									...
									<div class="row">
										...
										<?php 
										 ...
										 ?>
										<div class="col-sm-4">
											<input type="date" name="fecha_calibracion" id="fecha_calibracion" required="" min="2015-01-01" max="<?php echo $fecha_superior;?>" onblur="set_fecha_programada_edit_calibracion()" onchange="set_fecha_programada_edit_calibracion()">
										</div>
										<div class="col-sm-2">
