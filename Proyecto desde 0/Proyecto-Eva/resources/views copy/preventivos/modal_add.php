					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								...
								<form action="<?php echo base_url();?>equipo/Cequipos/addPreventivo" id="form_preventivo" name="form_preventivo" enctype="multipart/form-data" method="post">
									<br>
									...
									<div class="row">
										<div class="col-md-12" >
											...
											<textarea placeholder="Ingrese observaciones pertinentes a tareas adicionales al mantenimieno preventivo como ajustes, Equipo fuera de servicio, etc" class="form-control" name="observacion" id="observacion" cols="100" rows="3"></textarea>				
										</div>
									</div><br>
									<div class="row">
										<div class="col-md-4 mostrar-primer-fecha-padre" >
											<label for="">Primer mes:</label><br>
											<div class="mostrar-primer-fecha"></div>
										</div>
										<div class="col-md-4 mostrar-segunda-fecha-padre" >
											<label for="">Segundo mes:</label><br>
											<div class="mostrar-segunda-fecha"></div>
										</div>
										<div class="col-md-4 mostrar-tercer-fecha-padre" >
									...
									<div class="row">
										...
										$fecha_superior=date("Y-m-d",strtotime(date("Y-m-d")));
										?>
										<div class="col-md-4">
											<input type="date" class="form-control" name="fecha_mantenimiento" id="fecha_mantenimiento" required="" min="2010-01-01" max="<?php echo $fecha_superior;?>">
										</div>
<!-- 										<div class="col-md-4">
