					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								...
								<form action="<?php echo base_url();?>equipo/Cequipos/updatePreventivo" id="form_update_preventivo" name="form_update_preventivo" enctype="multipart/form-data" method="post">
									<br>
									...
									<div class="row">
										...
										<?php 
										 ...
										 ?>										
										<div class="col-sm-4">
											<!-- <input type="date" class="form-control" name="fecha_mantenimiento" id="fecha_mantenimiento" required="" min="2015-01-01" max="<?php echo $fecha_superior;?>" onblur="set_fecha_programada_edit()" onchange="set_fecha_programada_edit()"> -->
