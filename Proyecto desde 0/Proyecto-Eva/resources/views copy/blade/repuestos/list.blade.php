      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 table-responsive editarServicio">
            <form action="{{ asset('') }}ubicacion/Crepuestos/update" id="form_repuesto" name="form_repuesto" enctype="multipart/form-data" method="post">
      @csrf
...
<script>
  var base_url = "{{ asset('') }}"; // Corrected to use Blade syntax
  var controlador = "{{ session('controlador') }}"; // Corrected to use Blade syntax
</script>
