...
<div id="Formato ticket_4158" align=center x:publishsource="Excel" class="impresion-ticket">
  ...
  <table border=0 cellpadding=0 cellspacing=0 width=1196 style='border-collapse:
    ...
    <tr height=58 style='mso-height-source:userset;height:43.5pt'>
      ...
      <td align=left valign=top>
        ...
        <span style='mso-ignore:vglayout;
				...
				height:59px'><img width=82 height=59 src="{{ asset('assets/template/logo_hospital.jpg') }}"></span>
      </td>
    ...
    <tr height=20 style='height:15.0pt'>
      ...
      <td colspan=2 class=xl1204158>&nbsp;{{ ($orden->equipo_id != 0) ? $orden->nombre_equipo_db : $orden->nombre_equipo }}</td>
      <td class=xl664158>Serie</td>
      <td class=xl1204158>&nbsp;{{ ($orden->equipo_id != 0) ? $orden->serie_equipo_db : $orden->serie_equipo }}</td>
      <td class=xl744158>No. Inventario</td>
      <td class=xl1204158>&nbsp;{{ ($orden->equipo_id != 0) ? $orden->codigo_equipo_db : $orden->codigo_equipo }}</td>
      <td class=xl154158></td>
      <td class=xl154158></td>
      <td class=xl154158></td>
      <td class=xl754158>&nbsp;</td>
    ...
    <tr height=20 style='height:15.0pt'>
      ...
      <td colspan=2 class=xl1204158>&nbsp;{{ ($orden->equipo_id != 0) ? $orden->modelo_equipo_db : $orden->modelo_equipo }}</td>
      <td class=xl664158>Marca</td>
      <td class=xl1144158 style='border-top:none'>&nbsp;{{ ($orden->equipo_id != 0) ? $orden->marca_equipo_db : $orden->marca_equipo }}</td>
      <td class=xl154158></td>
      <td class=xl664158>Solicitado por</td>
      <td class=xl1044158></td>
      <td colspan=2 class=xl1184158>&nbsp;{{ ($orden->nombre_reportante != "") ? $orden->nombre_reportante : $orden->nombre . " " . $orden->apellido }}</td>
      <td class=xl754158>&nbsp;</td>
    </tr>
    <tr height=20 style='height:15.0pt'>
      <td height=20 class=xl764158 style='height:15.0pt'>&nbsp;</td>
      ...
      <td colspan=2 class=xl1194158>&nbsp;{{ ($orden->nombre_reportante != "") ? "No aplica" : $orden->email }}</td>
      <td class=xl754158>&nbsp;</td>
    </tr>
    ...
    <tr class=xl154158 height=20 style='height:15.0pt'>
        ...
        <div class="row">
          <div class="col-sm-2">
            @if($orden->file_diagnostico != "" && $orden->file_diagnostico != NULL && $orden->file_diagnostico != null)
              <a style="color: #1c1f23;font-size: 18px;" href="{{ asset('assets/upload_correctivos_generales/' . $orden->file_diagnostico) }}" target="__blank" class="fa fa-paperclip"></a>
            @endif
          </div>
          <div class="col-sm-10">
      ...
      <td colspan=2 rowspan=4 class=xl1054158>&nbsp;{{ ($orden->tecnico_diagnostico_text != "" && $orden->tecnico_diagnostico_text != NULL && $orden->tecnico_diagnostico_text != null) ? $orden->tecnico_diagnostico_text : $orden->nombre_tecnico_diagnostico . " " . $orden->apellido_tecnico_diagnostico }}</td>
      <td colspan=2 rowspan=4 class="xl1054158 ">&nbsp;<div class="ajustar-texto">{!! ($orden->repuesto_pendiente_condicion != "") ? "<strong>Repuesto pendiente?</strong>" : "" !!}&nbsp;{{ $orden->repuesto_pendiente_condicion }}<br><br>{{ $orden->repuesto_pendiente }}
        </div>
      </td>
    ...
    <tr class=xl154158 height=20 style='height:15.0pt'>
          ...
          <div class="ajustar-texto">
            <div class="col-sm-2">
              @if($orden->file_cierre != "" && $orden->file_cierre != NULL && $orden->file_cierre != null)
                <a href="{{ asset('assets/upload_correctivos_generales/' . $orden->file_cierre) }}" target="__blank" class="fa fa-paperclip" style="color:#1c1f23;font-size: 18px;"></a>
              @endif
            </div>__-__
            <div class="col-sm-8">
      ...
      @else
        <td colspan=2 rowspan=4 class=xl1054158>&nbsp;{{ ($orden->tecnico_cierre_text != "" && $orden->tecnico_cierre_text != NULL && $orden->tecnico_cierre_text != null) ? $orden->tecnico_cierre_text : $orden->nombre_tecnico_cierre . " " . $orden->apellido_tecnico_cierre }}</td>
      @endif
                  ...
                  <div class="col-sm-4">
                    <div class="ajustar-texto">
                      ...
                      @if($avance->file != "" && $avance->file != NULL && $avance->file != null)
                        <a href="{{ asset('assets/upload_correctivos_generales/' . $avance->file) }}" target="__blank" class="btn btn-dark fa fa-paperclip"></a>
                      @endif
                    </div>
                  </div>
                </div>
