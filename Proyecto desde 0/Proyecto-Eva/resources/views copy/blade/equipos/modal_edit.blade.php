<div id="modal_update_equipo" class="modal fade" role="dialog">
                                ...
                                <form action="{{ asset('') }}equipo/Cequipos/update" id="form_update_equipo" name="form_update_equipo" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="table-responsive">
                                        <div class="tg-wrap">
                                            <table class="tg">
                                                <tr>
                                                    <th class="tg-5xx9" colspan="10">EDICIÓN DE HOJA DE VIDA PARA EQUIPOS {{ $tipo_id == 1 ? "BIOMÉDICOS" : "INDUSTRIALES" }} HOSPITAL UNIVERSITARIO DEL VALLE "EVARISTO GARCÍA"</th>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tg-0pky text-center" colspan="4">
                                                        ...
                                                        <input type="text" class="form-control" name="descripcion" id="descripcion" placeholder="Descripción adicional">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tg-fymr" colspan="2">Antiguo:<input class="form-control" type="text" name="codigo_antiguo" id="codigo_antiguo" placeholder="Código antiguo"></td>
                                                    <td class="tg-fymr" colspan="2">Nuevo:<input type="text" class="form-control" placeholder="Código de inventario" name="code" id="code"></td>
                                                </tr>
                                                <tr>
                                                    <td class="tg-g8x9">Marca:</td>
                                                    <td class="tg-0pky" colspan="4">
                                                        <input autocomplete="off" type="text" class="form-control input-sm" placeholder="Marca" name="marca" id="marca" list="listadoMarcasFromUpdate">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tg-0pky" colspan="4">
                                                        <input autocomplete="off" type="text" class="form-control input-sm" placeholder="Modelo" name="modelo" id="modelo" list="listadoModelosFromUpdate">
                                                    ...
                                                    <td class="tg-0pky" colspan="4">
                                                        <ul class="list-inline">
                                                            ...
                                                            <li class="list-inline-item">
                                                                ...
                                                                @foreach($acciones as $accion)
                                                                    @if($accion->modulo == "areas" && $accion->insertar == 1)
                                                ...
                                                <tr>
                                                    <td class="tg-g8x9">Equipo (Móvil/fijo):</td>
                                                    <td class="tg-0pky" colspan="2">
                                                    ...
                                                    <td class="tg-0pky"><span style="font-weight:700">País de origen:</span></td>
                                                    <td class="tg-0pky"></td>
                                                </tr>
                                                <tr>
                                                    <td class="tg-d4yz" colspan="5">REGISTRO HISTÓRICO</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="tg-0pky"><span style="font-weight:700">Garantía:</span></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tg-0pky" colspan="9"><input class="form-control" type="text" name="activo_comodato" id="activo_comodato" placeholder="Código de comodato"></td>
                                                </tr>
                                                <tr>
    ...
    <td class="tg-0akb">Frecuencia de mantenimiento:</td>
    <td class="tg-0pky" colspan="9">
        <select required class="form-control frecuencia_id" name="frecuencia_id" id="frecuencia_id"></select>
    </td>
</tr>
<tr>
...
<tr>
    <td class="tg-ppov"><span style="font-weight:bold">Verificación física:</span></td>
    <td class="tg-0lax" colspan="9">
        <select class="form-control" id="verificacion_inventario" name="verificacion_inventario">
            ...
            <option value="NOENCONTRA">NO SE ENCONTRÓ</option>
        </select>
    </td>
</tr>
<tr>
...
<tr>
    <td class="tg-gj0n" colspan="10">
        OTROS CORRECTIVOS&nbsp;
        <a onclick="reset_form_add_correctivos();" href="" class="esconder btn btn-info glyphicon glyphicon-plus" data-toggle="modal" data-target="#modal_add_correctivo_general" style="font-size: 5px;"></a>
    </td>
</tr>
<tr>
    <td class="tg-0lax" colspan="10">
        <table class="table table-condensed tblCorrectivosGenerales" style="font-size: 10px;">
            <thead>
                <tr>
...
<tr>
    <td class="tg-gj0n" colspan="10">
        PREVENTIVOS &nbsp;
        <a href="" class="esconder btn btn-info glyphicon glyphicon-plus" data-toggle="modal" data-target="#modal_add_preventivo" style="font-size: 5px;"></a>
    </td>
</tr>
<tr>
    <td class="tg-0lax" colspan="10">
...
<tr>
    <td class="tg-gj0n" colspan="10">
        CALIBRACIONES&nbsp;
        <a href="" class="esconder btn btn-info glyphicon glyphicon-plus" data-toggle="modal" data-target="#modal_add_calibracion" style="font-size: 5px;"></a>
    </td>
</tr>
<tr>
    <td class="tg-0lax" colspan="10">
...
<tr>
    <td class="tg-gj0n" colspan="10">
        ...
        <a href="" class="esconder btn btn-info glyphicon glyphicon-plus" data-toggle="modal" data-target="#modal_add_repuesto" style="font-size: 5px;"></a>
    </td>
</tr>
<tr>
    <td class="tg-0lax" colspan="10">
...
<div class="box-footer">
    <button type="submit" class="btn btn-primary" id="btn_update_equipo">Actualizar</button>
</div>
