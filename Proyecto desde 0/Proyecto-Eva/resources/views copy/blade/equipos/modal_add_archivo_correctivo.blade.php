						...
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								<form action="{{ asset('') }}equipo/Cequipos/addArchivoCorrectivoGeneral" id="form_archivo_correctivo_general" name="form_archivo_correctivo_general" enctype="multipart/form-data" method="post">
									...
									<input required="" class="form-control" id="titulo" name="titulo" type="text" placeholder="Titulo">
									<div class="row">
										<div class="row">
									...
									<div class="box-footer">
										<button type="submit" class="btn btn-primary" id="btn_add_archivo_correctivo_general">Ingresar</button>
									</div>
								</form>
							</div>
						</div>
