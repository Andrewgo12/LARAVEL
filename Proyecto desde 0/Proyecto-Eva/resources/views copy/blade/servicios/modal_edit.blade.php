<div id="modal_update_servicio" class="modal fade" role="dialog">
                    ...
                    <div class="col-md-12">
                        <div class="box box-info">
                            ...
                            <div class="box-body form-horizontal">
                                <form action="" name="form_update_servicio" class="form_update_servicio" enctype="multipart/form-data" method="post" onsubmit="(new serviceObj).HandleSubmitUpdate(event)">
      @csrf
