    ...
    <div class="box box-solid">
      ...
      @csrf
              ...
              <div class="box-footer">
                {{-- Se asume que $acciones se pasa a la vista. Si no, usar @foreach(session('acciones') as $accion) --}}
...
<!-- /.content-wrapper -->
<script>
  var base_url = "{{ asset('') }}"; // Corregido a sintaxis Blade
  var controlador = "{{ session('controlador') }}"; // Corregido a sintaxis Blade
  var eliminar_servicio = "{{ session('acciones')[2]->eliminar }}"; // Corregido a sintaxis Blade
  var editar_servicio = "{{ session('acciones')[2]->editar }}"; // Corregido a sintaxis Blade
</script>
