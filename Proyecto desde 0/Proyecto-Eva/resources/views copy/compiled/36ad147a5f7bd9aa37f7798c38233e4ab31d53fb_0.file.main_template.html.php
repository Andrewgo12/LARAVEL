        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('adminlte/AdminLTE/dist/img/user2-160x160.jpg') }}"
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <!-- Añade aquí más elementos según necesites -->
                            </ul>
                        </li>
        ...
        <div class="wrapper">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active">@yield('header_breadcrumb', 'Panel')</li>
                                </ol>
                            </div>
                        </div>
                    </div>
            ...
            <footer class="main-footer">
                ...
                <div class="float-right d-none d-sm-inline-block">
                    <b>Versión</b> 3.2.0-rc
                </div>
            </footer>

            <!-- Sidebar opcional -->
            <aside class="control-sidebar control-sidebar-dark">
                <!-- Puedes incluir contenido aquí -->
            </aside>
        </div>
