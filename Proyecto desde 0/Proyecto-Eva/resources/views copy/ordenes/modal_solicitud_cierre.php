					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								...
								<form action="<?php echo base_url();?>orden/Cordenes/update_solicitar_cierre_orden" id="form_solicitar_cierre_orden" name="form_solicitar_cierre_orden" class="form_solicitar_cierre_orden" enctype="multipart/form-data" method="post">
									...
									<ul class="list-inline">
										<li class="list-inline-item">
											<h3>Retro diagnostico</h3>
											<h4>
												<span class="retro_diagnostico"></span>
											</h4>
										</li>
										<li class="list-inline-item">
											<h3>Diagnostico</h3>
										...
										<li class="list-inline-item">
											<h3>Codificación de diagnostico</h3>
											<h4>
												<span class="contenedor_codigo_diagnostico"></span>
											</h4>
										</li>
										...
										<li class="list-inline-item">
											...
											<h4>
												<span class="fecha_diagnostico"></span>
											</h4>
										</li>
									...
									<ul class="list-inline">
										<li class="list-inline-item">
											<h4>Retro cierre</h4>
											<h5>
												<input required="" type="text" class="form-control" id="retro_cierre" name="retro_cierre" placeholder="Ingrese retro diagnostico">
											</h5>
										</li>
										<li class="list-inline-item">
											<h4>Trabajo realizado</h4>
											<h5>
												<textarea required="" name="reparacion" id="reparacion" cols="50" rows="5" placeholder="Indique cual fue la intervención realizada"></textarea>
											</h5>
										</li>
										<li class="list-inline-item">
