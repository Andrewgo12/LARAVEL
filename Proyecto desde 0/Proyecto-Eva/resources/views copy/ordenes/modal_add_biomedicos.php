	...
	<div class="modal-dialog" style="width: 75%;">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title lead">Nueva orden de trabajo equipos biomedicos</h4>
			</div>
					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								...
								<form action="<?php echo base_url(); ?>orden/Cordenes/add" id="form_orden_biomedicos" name="form_orden_biomedicos" class="form_orden" enctype="multipart/form-data" method="post">
												...
												<div class="row">
													<div class="col-sm-12 ">
														<div class="panel panel-default">
															<br>
															<ul>
																<li><input class="seleccion_reportante_biomedicos" type="radio" name="seleccion_reportante" value="propio" checked="">Propio</li>
																<li><input class="seleccion_reportante_biomedicos" type="radio" name="seleccion_reportante" value="otro">Otro</li>
															</ul>
									...
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<div class="row">
												<div class="col-xs-5">
													<a title="Seleccionar equipo" onclick="funcion_get_equipos_biomedicos(1)" style="color:#20123a;font-weight: 1000;font-size: 25px;" href="" class="text-primary fa fa-search" data-toggle="modal" data-target="#modal_consulta_equipos_biomedicos"></a><small class="text-muted">Buscar equipo en la base de datos</small>
													<p>
												...
												<div class="col-xs-4">
													<div><a onclick="set_manual(event)" href="" class="text-secundary btn btn-light fa fa-pencil"></a><small class="text-muted">Ingresar de Forma Manual</small></div>
										...
										<div class="panel-body">
											<div class="row">
												...
												<div class="col-sm-4">
													...
													<select title="ubicación actual del equipo biomedico" name="area_id" id="area_id" class="form-control area_id " style="width:100%">
														<option value="">-----</option>
													</select>
