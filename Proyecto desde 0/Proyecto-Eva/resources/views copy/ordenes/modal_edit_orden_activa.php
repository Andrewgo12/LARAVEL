				...
				<div class="row">
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body ">
								<form action="<?php echo base_url(); ?>equipo/Cequipos/updateCalibracion" id="form_update_orden_activa" name="form_update_orden_activa" enctype="multipart/form-data" method="post">
									<div class="row">
										<div class="col-sm-3">
