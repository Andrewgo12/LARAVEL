...
/**
 * Controlador Ctecnologias - Sistema HUV
 * Gestiona las funcionalidades del módulo correspondiente
 */
class Ctecnologias extends Controller
{
    /**
...
/* Sistema HUV */
    public function index()
    {
        ...
        return view('laravel.tecnologias.list', $data);
    }
    ...
    public function getServerSide(Request $request): JsonResponse
    {
        try {
            $params = $request->all();
            $result = Mtecnologias::getServerSide($params);
    ...
    public function getAll(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mtecnologias::getAll($data);
    ...
    public function getByCategoria(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mtecnologias::getByCategoria($data);
    ...
    public function getCategorias(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mtecnologias::getCategorias($data);
    ...
    public function addCategoria(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mtecnologias::addCategoria($data);
