...
/**
 * Controlador Criesgos - Sistema HUV
 * Gestiona las funcionalidades del módulo correspondiente
 */
class Criesgos extends Controller
{
    /**
...
/* Sistema HUV */
    public function index()
    {
        ...
        return view('laravel.riesgos.list', $data);
    }
    ...
    public function getServerSide(Request $request): JsonResponse
    {
        try {
            $params = $request->all();
            $result = Mriesgos::getServerSide($params);
    ...
    public function getByCategoria(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mriesgos::getByCategoria($data);
    ...
    public function getCategorias(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mriesgos::getCategorias($data);
    ...
    public function addCategoria(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mriesgos::addCategoria($data);
