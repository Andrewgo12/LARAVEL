...
/**
 * Controlador Ccierres - Sistema HUV
...
/* Sistema HUV */
    public function index()
    {
        ...
        return view('laravel.cierres.list', $data);
    }
    ...
    public function getServerSide(Request $request): JsonResponse
    {
        try {
            $params = $request->all();
            $result = Mcierres::getServerSide($params);
    ...
    public function getHistorial(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mcierres::getHistorial($data);
    ...
    public function exportPDF(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mcierres::exportPDF($data);
