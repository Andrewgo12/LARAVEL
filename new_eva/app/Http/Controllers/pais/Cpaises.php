...
/**
 * Controlador Cpaises - Sistema HUV
 * Gestiona las funcionalidades del módulo correspondiente
 */
class Cpaises extends Controller
{
    /**
...
/* Sistema HUV */
    public function index()
    {
        ...
        return view('laravel.paises.list', $data);
    }
    ...
    public function getServerSide(Request $request): JsonResponse
    {
        try {
            $params = $request->all();
            $result = Mpaises::getServerSide($params);
