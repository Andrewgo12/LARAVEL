...
/**
 * Controlador Ccontingencias - Sistema HUV
...
/* Sistema HUV */
    public function index()
    {
        ...
        return view('laravel.contingencias.list', $data);
    }
    ...
    public function getServerSide(Request $request): JsonResponse
    {
        try {
            $params = $request->all();
            $result = Mcontingencias::getServerSide($params);
    ...
    public function add(Request $request): JsonResponse
    {
        try {
            ...
            $result = Mcontingencias::add($data);
    ...
    public function update(Request $request): JsonResponse
    {
        try {
            ...
            $result = Mcontingencias::edit($data);
    ...
    public function delete(Request $request): JsonResponse
    {
        try {
            $id = $request->input('id');
            $result = Mcontingencias::remove($id);
    ...
    public function activar(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mcontingencias::activar($data);
    ...
    public function desactivar(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mcontingencias::desactivar($data);
    ...
    public function getHistorial(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mcontingencias::getHistorial($data);
    ...
    public function exportPDF(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mcontingencias::exportPDF($data);
    ...
    public function exportExcel(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mcontingencias::exportExcel($data);
