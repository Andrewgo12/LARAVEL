...
/**
 * Controlador Cbajas - Sistema HUV
...
/* Sistema HUV */
    public function index()
    {
        ...
        return view('laravel.bajas.list', $data);
    }
    ...
    public function getServerSide(Request $request): JsonResponse
    {
        try {
            $params = $request->all();
            $result = Mbajas::getServerSide($params);
    ...
    public function getHistorial(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mbajas::getHistorial($data);
    ...
    public function exportExcel(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mbajas::exportExcel($data);
    ...
    public function getReportes(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mbajas::getReportes($data);
