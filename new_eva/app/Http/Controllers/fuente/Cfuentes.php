...
/**
 * Controlador Cfuentes - Sistema HUV
 * Gestiona las funcionalidades del módulo correspondiente
 */
class Cfuentes extends Controller
{
    /**
    ...
    /**
namespace App\Http\Controllers\Fuente;
...
/* Sistema HUV */
    public function index()
    {
        ...
        return view('laravel.fuentes.list', $data);
    }
    ...
    public function getServerSide(Request $request): JsonResponse
    {
        try {
            $params = $request->all();
            $result = Mfuentes::getServerSide($params);
