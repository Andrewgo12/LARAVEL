...
/**
 * Controlador Ctipos_compra - Sistema HUV
...
class Ctipos_compra extends Controller
{
    ...
    /**
namespace App\Http\Controllers\Tipos_compra;
...
/* Sistema HUV */
    public function index()
    {
        ...
        return view('laravel.tipos_compra.list', $data);
    }
    ...
    public function getServerSide(Request $request): JsonResponse
    {
        try {
            $params = $request->all();
            $result = Mtipos_compra::getServerSide($params);
    ...
    public function update(Request $request): JsonResponse
    {
        try {
            ...
            $result = Mtipos_compra::edit($data);
    ...
    public function delete(Request $request): JsonResponse
    {
        try {
            $id = $request->input('id');
            $result = Mtipos_compra::remove($id);
    ...
    public function getAll(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mtipos_compra::getAll($data);
