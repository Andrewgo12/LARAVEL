...
/**
 * Controlador Cmovimientos - Sistema HUV
 * Gestiona las funcionalidades del módulo correspondiente
 */
class Cmovimientos extends Controller
{
    /**
...
/* Sistema HUV */
    public function index()
    {
        ...
        return view('laravel.movimientos.list', $data);
    }
    ...
    public function getServerSide(Request $request): JsonResponse
    {
        try {
            $params = $request->all();
            $result = Mmovimientos::getServerSide($params);
    ...
    public function getByEquipo(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mmovimientos::getByEquipo($data);
    ...
    public function getByTipo(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mmovimientos::getByTipo($data);
    ...
    public function getTipos(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mmovimientos::getTipos($data);
    ...
    public function getHistorial(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mmovimientos::getHistorial($data);
