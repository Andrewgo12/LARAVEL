...
/**
 * Controlador Cadquisiciones - Sistema HUV
 * Gestiona las funcionalidades del módulo correspondiente
 */
class Cadquisiciones extends Controller
{
    /**
...
/* Sistema HUV */
    public function index()
    {
        ...
        return view('laravel.adquisiciones.list', $data);
    }
    ...
    public function getServerSide(Request $request): JsonResponse
    {
        try {
            $params = $request->all();
            $result = Madquisiciones::getServerSide($params);
    ...
    public function add(Request $request): JsonResponse
    {
        try {
            ...
            $result = Madquisiciones::add($data);
    ...
    public function update(Request $request): JsonResponse
    {
        try {
            ...
            $result = Madquisiciones::edit($data);
    ...
    public function delete(Request $request): JsonResponse
    {
        try {
            $id = $request->input('id');
            $result = Madquisiciones::remove($id);
    ...
    public function getAll(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Madquisiciones::getAll($data);
    ...
    public function getByTipo(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Madquisiciones::getByTipo($data);
    ...
    public function getTipos(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Madquisiciones::getTipos($data);
    ...
    public function addTipo(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Madquisiciones::addTipo($data);
