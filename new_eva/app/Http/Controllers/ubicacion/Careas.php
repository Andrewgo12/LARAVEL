...
/**
 * Controlador Careas - Sistema HUV
 * Gestiona las funcionalidades del módulo correspondiente
 */
class Careas extends Controller
{
    /**
...
/* Sistema HUV */
    public function index()
    {
        ...
        return view('laravel.areas.list', $data);
    }
    ...
    public function getServerSide(Request $request): JsonResponse
    {
        try {
            $params = $request->all();
            $result = Mareas::getServerSide($params);
    ...
    public function getByServicio(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mareas::getByServicio($data);
