...
/**
 * Controlador Csedes - Sistema HUV
...
/* Sistema HUV */
    public function index()
    {
        ...
        return view('laravel.sedes.list', $data);
    }
    ...
    public function getServerSide(Request $request): JsonResponse
    {
        try {
            $params = $request->all();
            $result = Msedes::getServerSide($params);
