...
/**
 * Controlador Ccentros - Sistema HUV
...
/* Sistema HUV */
    public function index()
    {
        ...
        return view('laravel.centros.list', $data);
    }
    ...
    public function getServerSide(Request $request): JsonResponse
    {
        try {
            $params = $request->all();
            $result = Mcentros::getServerSide($params);
