...
/**
 * Controlador Croles - Sistema HUV
...
/* Sistema HUV */
    public function index()
    {
        ...
        return view('laravel.roles.list', $data);
    }
    ...
    public function getServerSide(Request $request): JsonResponse
    {
        try {
            $params = $request->all();
            $result = Mroles::getServerSide($params);
