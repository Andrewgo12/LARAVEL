...
/**
 * Controlador Cempresas - Sistema HUV
...
/* Sistema HUV */
    public function index()
    {
        ...
        return view('laravel.empresas.list', $data);
    }
    ...
    public function getServerSide(Request $request): JsonResponse
    {
        try {
            $params = $request->all();
            $result = Mempresas::getServerSide($params);
