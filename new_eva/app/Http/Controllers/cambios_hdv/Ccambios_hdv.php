...
/**
 * Controlador Ccambios_hdv - Sistema HUV
...
class Ccambios_hdv extends Controller
{
    ...
    /**
namespace App\Http\Controllers\Cambios_hdv;
...
/* Sistema HUV */
    public function index()
    {
        ...
        return view('laravel.cambios_hdv.list', $data);
    }
    ...
    public function getServerSide(Request $request): JsonResponse
    {
        try {
            $params = $request->all();
            $result = Mcambios_hdv::getServerSide($params);
    ...
    public function getByEquipo(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mcambios_hdv::getByEquipo($data);
    ...
    public function getHistorial(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mcambios_hdv::getHistorial($data);
    ...
    public function exportPDF(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mcambios_hdv::exportPDF($data);
    ...
    public function exportExcel(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mcambios_hdv::exportExcel($data);
