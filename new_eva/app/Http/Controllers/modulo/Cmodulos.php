...
/**
 * Controlador Cmodulos - Sistema HUV
...
/* Sistema HUV */
    public function index()
    {
        ...
        return view('laravel.modulos.list', $data);
    }
    ...
    public function getServerSide(Request $request): JsonResponse
    {
        try {
            $params = $request->all();
            $result = Mmodulos::getServerSide($params);
    ...
    /* Sistema HUV */
    public function getPermisos(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mmodulos::getPermisos($data);

            return response()->json($result, 200);
        } catch (\Exception $e) {
            return response()->json(['error' => 'Error en getPermisos: ' . $e->getMessage()], 500);
        }
    }
    ...
    public function updatePermisos(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mmodulos::updatePermisos($data);
