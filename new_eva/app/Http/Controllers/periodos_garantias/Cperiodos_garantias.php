...
/**
 * Controlador Cperiodos_garantias - Sistema HUV
 * Gestiona las funcionalidades del módulo correspondiente
 */
class Cperiodos_garantias extends Controller
{
    /**
    ...
    /**
namespace App\Http\Controllers\Periodos_garantias;
...
use App\Models\Mperiodos_garantias;
...
/* Sistema HUV */
    public function index()
    {
        ...
        return view('laravel.periodos_garantias.list', $data);
    }
    ...
    public function getServerSide(Request $request): JsonResponse
    {
        try {
            $params = $request->all();
            $result = Mperiodos_garantias::getServerSide($params);
    ...
    public function getOne(Request $request): JsonResponse
    {
        try {
            $id = $request->input('id');
            $item = Mperiodos_garantias::getOne($id);
    ...
    public function add(Request $request): JsonResponse
    {
        try {
            ...
            $result = Mperiodos_garantias::add($data);
    ...
    public function update(Request $request): JsonResponse
    {
        try {
            ...
            $result = Mperiodos_garantias::edit($data);
    ...
    public function delete(Request $request): JsonResponse
    {
        try {
            $id = $request->input('id');
            $result = Mperiodos_garantias::remove($id);
    ...
    public function getAll(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mperiodos_garantias::getAll($data);
    ...
    /* Sistema HUV */
    public function getVencimientos(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mperiodos_garantias::getVencimientos($data);

            return response()->json($result, 200);
        } catch (\Exception $e) {
            return response()->json(['error' => 'Error en getVencimientos: ' . $e->getMessage()], 500);
        }
    }

    /* Sistema HUV */
    public function getProximosVencer(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mperiodos_garantias::getProximosVencer($data);

            return response()->json($result, 200);
        } catch (\Exception $e) {
            return response()->json(['error' => 'Error en getProximosVencer: ' . $e->getMessage()], 500);
        }
    }
