...
/**
 * Controlador Carchivos - Sistema HUV
 * Gestiona las funcionalidades del módulo correspondiente
 */
class Carchivos extends Controller
{
    /**
...
/* Sistema HUV */
    public function index()
    {
        ...
        return view('laravel.archivos.list', $data);
    }
    ...
    public function getServerSide(Request $request): JsonResponse
    {
        try {
            $params = $request->all();
            $result = Marchivos::getServerSide($params);
    ...
    public function download(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Marchivos::download($data);
    ...
    public function compartir(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Marchivos::compartir($data);
    ...
    public function getByEquipo(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Marchivos::getByEquipo($data);
    ...
    public function getByTipo(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Marchivos::getByTipo($data);
    ...
    public function getTipos(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Marchivos::getTipos($data);
