...
/**
 * Controlador Ccambios_ubicaciones - Sistema HUV
 * Gestiona las funcionalidades del módulo correspondiente
 */
class Ccambios_ubicaciones extends Controller
{
    /**
    ...
    /**
namespace App\Http\Controllers\Cambios_ubicaciones;
...
/* Sistema HUV */
    public function index()
    {
        ...
        return view('laravel.cambios_ubicaciones.list', $data);
    }
    ...
    public function getServerSide(Request $request): JsonResponse
    {
        try {
            $params = $request->all();
            $result = Mcambios_ubicaciones::getServerSide($params);
    ...
    public function getOne(Request $request): JsonResponse
    {
        try {
            $id = $request->input('id');
            $item = Mcambios_ubicaciones::getOne($id);
    ...
    public function add(Request $request): JsonResponse
    {
        try {
            ...
            $result = Mcambios_ubicaciones::add($data);
    ...
    public function update(Request $request): JsonResponse
    {
        try {
            ...
            $result = Mcambios_ubicaciones::edit($data);
    ...
    public function delete(Request $request): JsonResponse
    {
        try {
            $id = $request->input('id');
            $result = Mcambios_ubicaciones::remove($id);
    ...
    public function aprobar(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mcambios_ubicaciones::aprobar($data);
    ...
    public function rechazar(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mcambios_ubicaciones::rechazar($data);
    ...
    public function getHistorial(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mcambios_ubicaciones::getHistorial($data);
    ...
    public function exportPDF(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mcambios_ubicaciones::exportPDF($data);
    ...
    public function exportExcel(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mcambios_ubicaciones::exportExcel($data);
