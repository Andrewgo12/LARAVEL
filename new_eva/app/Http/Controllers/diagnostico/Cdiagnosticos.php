...
/**
 * Controlador Cdiagnosticos - Sistema HUV
 * Gestiona las funcionalidades del módulo correspondiente
 */
class Cdiagnosticos extends Controller
{
    /**
...
/* Sistema HUV */
    public function index()
    {
        ...
        return view('laravel.diagnosticos.list', $data);
    }
    ...
    public function getServerSide(Request $request): JsonResponse
    {
        try {
            $params = $request->all();
            $result = Mdiagnosticos::getServerSide($params);
    ...
    public function update(Request $request): JsonResponse
    {
        try {
            ...
            $result = Mdiagnosticos::edit($data);
    ...
    public function delete(Request $request): JsonResponse
    {
        try {
            $id = $request->input('id');
            $result = Mdiagnosticos::remove($id);
    ...
    public function getAll(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mdiagnosticos::getAll($data);
    ...
    public function getByTipo(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mdiagnosticos::getByTipo($data);
    ...
    public function getTipos(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mdiagnosticos::getTipos($data);
    ...
    public function addTipo(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mdiagnosticos::addTipo($data);
