...
/**
 * Controlador Ccategorias - Sistema HUV
...
/* Sistema HUV */
    public function index()
    {
        ...
        return view('laravel.categorias.list', $data);
    }
    ...
    public function getServerSide(Request $request): JsonResponse
    {
        try {
            $params = $request->all();
            $result = Mcategorias::getServerSide($params);
    ...
    public function getAll(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mcategorias::getAll($data);
    ...
    public function getByTipo(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mcategorias::getByTipo($data);
    ...
    public function getTipos(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mcategorias::getTipos($data);
