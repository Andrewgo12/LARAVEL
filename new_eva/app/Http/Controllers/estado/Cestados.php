...
/**
 * Controlador Cestados - Sistema HUV
 * Gestiona las funcionalidades del módulo correspondiente
 */
class Cestados extends Controller
{
    /**
...
/* Sistema HUV */
    public function index()
    {
        ...
        return view('laravel.estados.list', $data);
    }
    ...
    public function getServerSide(Request $request): JsonResponse
    {
        try {
            $params = $request->all();
            $result = Mestados::getServerSide($params);
