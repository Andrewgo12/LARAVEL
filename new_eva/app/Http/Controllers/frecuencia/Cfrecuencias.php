...
/**
 * Controlador Cfrecuencias - Sistema HUV
 * Gestiona las funcionalidades del módulo correspondiente
 */
class Cfrecuencias extends Controller
{
    /**
    ...
    /**
namespace App\Http\Controllers\Frecuencia;
...
/* Sistema HUV */
    public function index()
    {
        ...
        return view('laravel.frecuencias.list', $data);
    }
    ...
    public function getServerSide(Request $request): JsonResponse
    {
        try {
            $params = $request->all();
            $result = Mfrecuencias::getServerSide($params);
    ...
    public function getAll(Request $request): JsonResponse
    {
        try {
            $data = $request->all();
            $result = Mfrecuencias::getAll($data);
