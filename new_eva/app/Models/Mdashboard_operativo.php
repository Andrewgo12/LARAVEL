...
/**
 * Modelo Mdashboard_operativo - Sistema HUV
 * Gestiona los datos para el módulo dashboard_operativo
 */
class Mdashboard_operativo extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'dashboard_operativos';
