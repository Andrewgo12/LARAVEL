...
/**
 * Modelo Mdashboard_ejecutivo - Sistema HUV
 * Gestiona los datos para el módulo dashboard_ejecutivo
 */
class Mdashboard_ejecutivo extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'dashboard_ejecutivos';
