...
/**
 * Modelo PasswordResetLinkMontroller - Sistema HUV
 * Gestiona los datos para el módulo passwordresetlinkontroller
 */
class PasswordResetLinkMontroller extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'passwordresetlinkontrollers';
