...
/**
 * Modelo MonfirmablePasswordMontroller - Sistema HUV
 * Gestiona los datos para el módulo onfirmablepasswordontroller
 */
class MonfirmablePasswordMontroller extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'onfirmablepasswordontrollers';
