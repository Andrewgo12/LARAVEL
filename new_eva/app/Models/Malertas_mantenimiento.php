...
/**
 * Modelo Malertas_mantenimiento - Sistema HUV
 * Gestiona los datos para el módulo alertas_mantenimiento
 */
class Malertas_mantenimiento extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'alertas_mantenimientos';
