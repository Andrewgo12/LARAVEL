...
/**
 * Modelo Mintegracion_cmms - Sistema HUV
 * Gestiona los datos para el módulo integracion_cmms
 */
class Mintegracion_cmms extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'integracion_cmms';
