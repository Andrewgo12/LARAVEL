...
/**
 * Modelo Mworkflow_ordenes - Sistema HUV
 * Gestiona los datos para el módulo workflow_ordenes
 */
class Mworkflow_ordenes extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'workflow_ordenes';
