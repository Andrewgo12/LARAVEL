...
/**
 * Modelo EmailVerificationNotificationMontroller - Sistema HUV
 * Gestiona los datos para el módulo emailverificationnotificationontroller
 */
class EmailVerificationNotificationMontroller extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'emailverificationnotificationontrollers';
