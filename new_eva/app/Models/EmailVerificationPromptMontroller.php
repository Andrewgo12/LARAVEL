...
/**
 * Modelo EmailVerificationPromptMontroller - Sistema HUV
 * Gestiona los datos para el módulo emailverificationpromptontroller
 */
class EmailVerificationPromptMontroller extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'emailverificationpromptontrollers';
