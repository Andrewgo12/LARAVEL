...
/**
 * Modelo VerifyEmailMontroller - Sistema HUV
 * Gestiona los datos para el módulo verifyemailontroller
 */
class VerifyEmailMontroller extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'verifyemailontrollers';
