...
/**
 * Modelo Mreportes_mantenimientos - Sistema HUV
 * Gestiona los datos para el módulo reportes_mantenimientos
 */
class Mreportes_mantenimientos extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'reportes_mantenimientos';
