...
/**
 * Modelo RegisteredUserMontroller - Sistema HUV
 * Gestiona los datos para el módulo registereduserontroller
 */
class RegisteredUserMontroller extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'registereduserontrollers';
