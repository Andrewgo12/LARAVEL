...
/**
 * Modelo Mreportes_equipos - Sistema HUV
 * Gestiona los datos para el módulo reportes_equipos
 */
class Mreportes_equipos extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'reportes_equipos';
