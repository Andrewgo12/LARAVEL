...
/**
 * Modelo Mestadisticas_mantenimientos - Sistema HUV
 * Gestiona los datos para el módulo estadisticas_mantenimientos
 */
class Mestadisticas_mantenimientos extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'estadisticas_mantenimientos';
