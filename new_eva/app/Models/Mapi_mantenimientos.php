...
/**
 * Modelo Mapi_mantenimientos - Sistema HUV
 * Gestiona los datos para el módulo api_mantenimientos
 */
class Mapi_mantenimientos extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'api_mantenimientos';
