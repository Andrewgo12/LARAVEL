...
/**
 * Modelo Mauditoria_sistema - Sistema HUV
 * Gestiona los datos para el módulo auditoria_sistema
 */
class Mauditoria_sistema extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'auditoria_sistemas';
