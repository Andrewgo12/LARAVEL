...
/**
 * Modelo Mconfiguracion_email - Sistema HUV
 * Gestiona los datos para el módulo configuracion_email
 */
class Mconfiguracion_email extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'configuracion_emails';
