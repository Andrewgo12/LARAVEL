...
/**
 * Modelo Mnotificaciones_email - Sistema HUV
 * Gestiona los datos para el módulo notificaciones_email
 */
class Mnotificaciones_email extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'notificaciones_emails';
