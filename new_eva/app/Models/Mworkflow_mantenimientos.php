...
/**
 * Modelo Mworkflow_mantenimientos - Sistema HUV
 * Gestiona los datos para el módulo workflow_mantenimientos
 */
class Mworkflow_mantenimientos extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'workflow_mantenimientos';
