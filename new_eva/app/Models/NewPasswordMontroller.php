...
/**
 * Modelo NewPasswordMontroller - Sistema HUV
 * Gestiona los datos para el módulo newpasswordontroller
 */
class NewPasswordMontroller extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'newpasswordontrollers';
