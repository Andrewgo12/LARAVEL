...
/**
 * Modelo Mbackup_archivos - Sistema HUV
 * Gestiona los datos para el módulo backup_archivos
 */
class Mbackup_archivos extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'backup_archivos';
