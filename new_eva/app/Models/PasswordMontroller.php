...
/**
 * Modelo PasswordMontroller - Sistema HUV
 * Gestiona los datos para el módulo passwordontroller
 */
class PasswordMontroller extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'passwordontrollers';
