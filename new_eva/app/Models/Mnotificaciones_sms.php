...
/**
 * Modelo Mnotificaciones_sms - Sistema HUV
 * Gestiona los datos para el módulo notificaciones_sms
 */
class Mnotificaciones_sms extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'notificaciones_sms';
