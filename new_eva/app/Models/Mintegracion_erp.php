...
/**
 * Modelo Mintegracion_erp - Sistema HUV
 * Gestiona los datos para el módulo integracion_erp
 */
class Mintegracion_erp extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'integracion_erps';
