...
/**
 * Modelo ProfileMontroller - Sistema HUV
 * Gestiona los datos para el módulo profileontroller
 */
class ProfileMontroller extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'profileontrollers';
