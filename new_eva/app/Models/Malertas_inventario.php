...
/**
 * Modelo Malertas_inventario - Sistema HUV
 * Gestiona los datos para el módulo alertas_inventario
 */
class Malertas_inventario extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'alertas_inventarios';
