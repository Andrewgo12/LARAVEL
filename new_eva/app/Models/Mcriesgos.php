...
* 
*/
class Mcriesgos extends CI_Model
{
	...
	public function get(){
		...
		$resultado = $this->db->get("criesgo");
		return $resultado->result();
	}
	public function getDistributionCriesgoOnDevices($param){
		...
		$query="
			SELECT
			    COUNT(*) AS cantidad,
			    (
			        CASE WHEN cr.name IS NULL THEN 'N/R' WHEN cr.name IS NOT NULL THEN cr.name
			    END
			) AS criesgo
			FROM
			    equipos eq
