...
/**
 * Modelo AuthenticatedSessionMontroller - Sistema HUV
 * Gestiona los datos para el módulo authenticatedsessionontroller
 */
class AuthenticatedSessionMontroller extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'authenticatedsessionontrollers';
