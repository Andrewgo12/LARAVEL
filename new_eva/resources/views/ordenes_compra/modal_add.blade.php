<div id="modal_add_orden_compra" class="modal fade" role="dialog">
					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								...
								<form action="" name="form_add_orden_compra" class="form_add_orden_compra" enctype="multipart/form-data" method="post">
									<br>
									<div class="row">
										<div class="col-sm-4">
