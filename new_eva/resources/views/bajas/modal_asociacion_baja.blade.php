<div class="modal fade" id="modal_asociacion_baja">
  <div class="modal-dialog" style="width:90%;">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="" class="form_asociacion_baja_equipos" id="form_asociacion_baja_equipos" name="form_asociacion_baja_equipos" enctype="multipart/form-data" method="post">
