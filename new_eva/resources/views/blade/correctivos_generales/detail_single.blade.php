                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <span class="text-muted">
                                            <a target="__blank" href="{{ asset('') }}assets/upload_correctivos_generales/{{ $archivo->file }}">{{ $archivo->file }}</a>
                                        </span><br>
                                    </div>
                                    <div class="col-sm-4">
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-1">
                                @if($avance->file != null && $avance->file != "")
                                    <span class=""><a href="{{ url('/') }}/assets/upload_correctivos_generales/{{ $avance->file }}" target="__blank" class="btn btn-dark glyphicon glyphicon-file"></a></span>
                                @endif
                            </div>
                            <div class="col-sm-3">
                                <span class="badge">Fecha:</span>
