        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            <ul class="lista_consolidados list-group">  
              <li class="list-group-item"><a href="{{ asset('') }}equipo/Cequipos/ConsolidadoCorrectivos" target="_blank">Correctivos Tickets</a></li>          
              <li class="list-group-item"><a href="{{ asset('') }}equipo/Cequipos/ConsolidadoCorrectivosGenerales" target="_blank">Otros correctivos</a></li>          
              <li class="list-group-item"><a href="{{ asset('') }}equipo/Cequipos/ConsolidadoPreventivos" target="_blank">Preventivos</a></li>          
              <li class="list-group-item"><a href="{{ asset('') }}equipo/Cequipos/ConsolidadoCalibraciones" target="_blank">Calibraciones</a></li>          
            </ul>
          </div>
          <!-- /.box-body -->
          <div class="box-footer clearfix">
