                    ...
                    <div class="col-md-12">
                        <div class="box box-info">
                            ...
                            <div class="box-body form-horizontal">
                                <form action="{{ asset('') }}equipo/Cequipos/exportarExcel" method="post" target="_blank">
                                    @csrf
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label for="filtro_code">Código:</label>
                                        </div>
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" id="filtro_code" name="filtro_code" placeholder="Código">
                                        </div>
                                        <div class="col-md-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label for="filtro_tadquisicion_id">Tipo adquisición:</label>
                                        </div>
                                        <div class="col-md-10">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <select class="form-control" name="filtro_estadom" id="filtro_estadom">
                                                <option value="">---------</option>
                                        ...
                                        <div class="col-md-5">
                                            <label for="proveedor_mantenimiento">Proveedor del mantenimiento:</label>
