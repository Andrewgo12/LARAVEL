					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								<form action="{{ asset('') }}equipo/Cequipos/addCalibracion" id="form_calibracion" name="form_calibracion" enctype="multipart/form-data" method="post">
									@csrf
									<br>
									...
									<div class="row">
										...
										<?php
										 ...
										 ?>
										<div class="col-sm-4">
											<input type="date" name="fecha_calibracion" id="fecha_calibracion" required min="2015-01-01" max="{{ $fecha_superior }}" onblur="set_fecha_programada_add_calibracion()" onchange="set_fecha_programada_add_calibracion()">
										</div>
										<div class="col-sm-2">
									...
									<div class="box-footer">
										<button type="submit" class="btn btn-primary" id="btn_add_calibracion">Ingresar</button>
									</div>
