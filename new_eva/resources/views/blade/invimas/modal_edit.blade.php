<div id="modal_update_invima" class="modal fade" role="dialog">
					...
					<div class="col-md-12">
						<div class="box box-info">
							<div class="box-header with-border">
								<h3 class="box-title">Registro sanitario</h3>
							</div>

							<div class="box-body form-horizontal">
								<form action="" name="form_update_invima" class="form_update_invima" enctype="multipart/form-data" method="post">
									@csrf
									<br>
