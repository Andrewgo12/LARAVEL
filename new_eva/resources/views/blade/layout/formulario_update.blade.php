              ...
              <form id="form_update" enctype="multipart/form-data" method="post" role="form">
                ...
                <div class="box-body" style="width: 600px; height: auto;">
                  ...
                  <div class="form-group">
                    ...
                    <select class="js-data-example-ajax1" name="servicio_id" id="servicio_id" style="width: 580px;"></select>
                  </div>
                  <div class="form-group">
                    <label for="periodicidad_id">Periodicidad de mantenimiento</label>
                    <select class="js-data-example-ajax2" name="periodicidad_id" id="periodicidad_id" style="width: 580px;"></select>
                  </div>
                  <div class="form-group">
                    <label for="piso_id">Piso</label>
                    <select class="js-data-example-ajax2" name="piso_id" id="piso_id" style="width: 580px;"></select>
                  </div>
                      ...
                      <table id="tbcalibraciones" style="margin-left: 10px">
                        <thead class="apendice_calibracion">
                          <tr height="27" style="mso-height-source:userset;height:20.25pt">
                            <td colspan="13.5" height="27" class="xl18926419" width="82" style="height:20.25pt; width:61pt">ID calibración</td>
                            <td colspan="18" class="xl20126419" width="259" style="border-right:.5pt solid black; width:200pt">Fecha ejecución</td>
                            <td colspan="13" class="xl18526419" width="63" style="width:48pt">Fecha programada</td>
                            <td colspan="10" class="xl20126419" width="348" style="border-right:.5pt solid black; width:263pt">Archivo relacionado</td>
                    ...
                    <div style="margin-left: 10px;">
                      ...
                      <table id="tbpreventivo">
                        <thead class="apendice_preventivo">
                          <tr height="27" style="mso-height-source:userset;height:20.25pt">
                            <td colspan="13.5" height="27" class="xl18926419" width="82" style="height:20.25pt; width:61pt">ID preventivo</td>
                            <td colspan="13.5" height="27" class="xl18926419" width="82" style="height:20.25pt; width:61pt">Descripcion</td>
                            <td colspan="18" class="xl20126419" width="259" style="border-right:.5pt solid black; width:200pt">Fecha ejecución</td>
                            <td colspan="13" class="xl18526419" width="63" style="width:48pt">Fecha programada</td>
                            <td colspan="10" class="xl20126419" width="348" style="border-right:.5pt solid black; width:263pt">Archivo relacionado</td>
                            <td class="xl1526419"></td>
                      ...
                      <table id="tbcorrectivo" style="margin-top: 1px">
                        <thead class="apendice_tickets">
                          <tr height="27" style="mso-height-source:userset;height:20.25pt">
                            <td colspan="13.5" height="27" class="xl18926419" width="82" style="height:20.25pt; width:61pt">ID Orden</td>
                            <td colspan="18" class="xl20126419" width="259" style="border-right:.5pt solid black; width:200pt">Descripción</td>
