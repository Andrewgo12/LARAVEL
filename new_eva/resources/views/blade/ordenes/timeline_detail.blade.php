...
?>
<?php if ({{ session('editar_orden') }} == "si") : ?>
        ...
        <div class="row">
          <div class="col-sm-2">
            @if($orden->file_diagnostico != "" && $orden->file_diagnostico != NULL && $orden->file_diagnostico != null)
              <a style="color: #1c1f23;font-size: 18px;" href="{{ asset('') }}assets/upload_correctivos_generales/<?php echo $orden->file_diagnostico; ?>" target="__blank" class="fa fa-paperclip"></a>
            <?php endif ?>
          </div>
          <div class="col-sm-10">
          ...
          <div class="ajustar-texto">
            <div class="col-sm-2">
              @if($orden->file_cierre != "" && $orden->file_cierre != NULL && $orden->file_cierre != null)
                <a href="{{ asset('') }}assets/upload_correctivos_generales/<?php echo $orden->file_cierre; ?>" target="__blank" class="fa fa-paperclip" style="color:#1c1f23;font-size: 18px;"></a>
              <?php endif ?>
            </div>
            <div class="col-sm-8">
                  ...
                  <div class="col-sm-4">
                    <div class="ajustar-texto">
                      ...
                      @if($avance->file != "" && $avance->file != NULL && $avance->file != null)
                        <a href="{{ asset('') }}assets/upload_correctivos_generales/<?php echo $avance->file; ?>" target="__blank" class="btn btn-dark fa fa-paperclip"></a>
                      <?php endif ?>
                    </div>
                  </div>
                </div>
