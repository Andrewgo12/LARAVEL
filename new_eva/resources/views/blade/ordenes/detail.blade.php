		...
		<div class="col-md-12">
			<div class="box box-info box-solid">
				...
				@if($orden->image!=null)
					<div class="row">
						<div class="col-sm-12">
							<label for="">Descripción <a class="esconder" href="{{ asset('') }}assets/upload_correctivos/<?php echo $orden->image;?>" target="__blank" class="glyphicon glyphicon-file lg" style="font-size: 10px;">Archivo de reporte</a></label><br>
							<?=$orden->descripcion;?>								
						</div>
					</div>
					@else
