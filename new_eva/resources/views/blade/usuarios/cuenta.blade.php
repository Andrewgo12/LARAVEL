...
<!--                 <li class="">
                  <strong>Año seleccionado plan de mantenimiento: </strong><span class="anio_seleccionado_plan"><?php echo {{ session('anio_plan') }}; ?></span>
...
<script>
  ...
  var usuario_id="<?php print_r({{ session('id') }}); ?>";
