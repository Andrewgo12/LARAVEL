    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          ...
          <div class="modal-title text-center" style="background-color: #888888;color: white;font-family: 'calibri';font-size: 30px;">Relacionar guias rapidas con equipos</div>
        </div>
        <div class="modal-body impresion" style="overflow-x: auto;">
          <form action="<?php echo base_url() ?>guia/Cguias/relacionar_con_equipos" id="formulario_guia" name="formulario_guia" enctype="multipart/form-data" method="post">
