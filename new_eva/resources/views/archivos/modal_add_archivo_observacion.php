    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body impresion">
          <form action="<?php echo base_url();?>equipo/Cequipos/addCalibracion" id="form_archivo_observacion" name="form_archivo_observacion" enctype="multipart/form-data" method="post">
            <br>
