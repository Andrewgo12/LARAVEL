...
<!--hoja de vida-->
<link rel=File-List
href="Formato%20hoja%20de%20Vida%20equipos%20REG-TEC-009_files/filelist.xml">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>HUV</b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Andres Herrera</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
