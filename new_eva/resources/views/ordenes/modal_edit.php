					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								...
								<form action="<?php echo base_url();?>orden/Cordenes/update" id="form_orden" name="form_orden" enctype="multipart/form-data" method="post">
									<input type="hidden" id="id"  name="id"><!--id de la orden para actualizar-->
									<input type="hidden" name="tecnico_cierre" id="tecnico_cierre" value="<?= $this->session->userdata('id');?>">
									<input type="hidden" name="tecnico_diagnostico" id="tecnico_diagnostico" value="<?= $this->session->userdata('id');?>">
									...
									<div class="subproceso_1"><!--subproceso_1 equipos biomedicos-->
										<?php if ($this->session->userdata("rol_id")<=2): ?><!--super admin o admin-->
...
<!-------            -------->		<div class="contenedor_input_diagnostico" style="display: none;"><!-- información del diagnostico -->
										<?php if ($this->session->userdata('rol_id')<=2): ?><!--Puede ingresar fecha de -->
