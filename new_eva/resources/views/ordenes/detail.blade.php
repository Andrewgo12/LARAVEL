		...
		<div class="col-md-12">
			<div class="box box-info box-solid">
				...
				@if($orden->image!=null)
					<div class="row">
						<div class="col-sm-12">
							<label for="">Descripción <a class="esconder" href="{{ url('/') }}assets/upload_correctivos/{{ $orden->image }}" target="__blank" class="glyphicon glyphicon-file lg" style="font-size: 10px;">Archivo de reporte</a></label><br>
							{{ $orden->descripcion; }}								
						</div>
					</div>
					@else
		...
		@if(($orden->estado_id>=2)&&($orden->estado_id!=null)&&($orden->estado_id!=""))<!-- Si esta asignado o se ha hecho gestion -->
		<div class="col-md-12">
			<div class="box box-info box-solid">
				<div class="box-header with-border">
				...
				<div class="box-body">
					<div class="row">
						<div class="col-sm-6">
							...
							<a target="__blank" href="{{ url('/'); }}assets/upload_correctivos/{{ $orden->file_diagnostico; }}">Archivo diagnostico</a>
						<?php endif ?>
						<br>
			...
			<div class="col-md-12">
				<div class="box box-info box-solid">
					...
					<div class="box-body">
						...
						<a target="__blank" href="{{ url('/'); }}assets/upload_correctivos/{{ $orden->file_cierre; }}">Archivo cierre</a>
						<?php endif ?><br>
