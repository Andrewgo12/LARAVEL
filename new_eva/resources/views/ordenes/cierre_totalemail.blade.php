											...
											<blockquote>
												@if($orden->tecnico_diagnostico_text!=""&&$orden->tecnico_diagnostico_text!=NULL)
													...
													@else
														...
														<h5><p>{{ "Email cuenta: ".$usuario_diagnostico->email }}</p>
														<?php endif ?>
													...
													<blockquote>
														...
														<h4>Trabajo realizado:</h4> <p>{{ $orden->reparacion }}</p>
													...
													<blockquote>
														@if($orden->tecnico_cierre_text!=""&&$orden->tecnico_cierre_text!=NULL)
															...
															@else
																...
																{{ $usuario_solicitud_cierre->nombre." "; echo $usuario_solicitud_cierre->apellido." " }}
																<h5><p>{{ "Email cuenta: ".$usuario_solicitud_cierre->email }}</p>
																<?php endif ?>

															</blockquote>
															<blockquote>
																<h4>Usuario que cierra la orden</h4>
																{{ $usuario_actual->nombre." "; echo $usuario_actual->apellido." " }}
																<h5><p>{{ "Email cuenta: ".$usuario_actual->email }}</p>
