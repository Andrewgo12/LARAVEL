...
if (isset($estados[$estado_id])) {
  ...
  if ($estado_id == 5 && $this->session->userdata("id") == $orden->reportante_id && $this->session->userdata("rol_id") == 4) {
...
?>
<?php if ($this->session->userdata("editar_orden") == "si") : ?>
  <?php if ($this->session->userdata("rol_id") <= 3) : ?>

    <?php if ($orden->subproceso_id <= 2 && $orden->equipo_id == 0) : ?><!--Logica para asociar un ID-->
      <div class="row">
        <div class="col-md-3">Asignar Id</div>
        <div class="col-md-3">
          <a href="" class="glyphicon glyphicon-search" onclick="">Consultar</a>
          <a href="" class="glyphicon glyphicon-tags" onclick="asignar_equipo_id(event,<?php echo $orden->id; ?>)">Asignar</a>
        </div>
        <div class="col-md-6">
    ...
    <ul class="list-inline to-hide">
      ...
      <?php if ($orden->repuesto_pendiente_condicion == "si") : ?>
        <li class="list-inline-item">
      ...
      <?php endif ?>
      <?php if (($orden->repuesto_pendiente_condicion == "no" || $orden->repuesto_pendiente_condicion == "") && strlen($orden->repuesto_pendiente) == 0) : ?>
        <li class="list-inline-item">
      ...
      <?php if ($orden->estado_id == 1) : ?><!--Abierto-->
        <?php if ($this->session->userdata("rol_id") <= 2) : ?>
          <?php if ($orden->subproceso_id == 1) : ?>
            <li class="list-inline-item"><a onclick="asignar(<?php echo $orden->id; ?>)" data-toggle="modal" data-target="#modal_asignar_orden" href="" class="btn btn-default"><span style="color: #dda70f;font-size: 20px;" class="fa fa-user"></span>Asignar responsable</a></li>
          <?php else : ?>
            <li class="list-inline-item"><a onclick="asignar_otro(<?php echo $orden->id; ?>)" data-toggle="modal" data-target="#modal_asignar_orden_otro" href="" class="btn btn-default"><span style="color: #dda70f;font-size: 20px;" class="fa fa-user"></span>Asociar tipo de trabajo y responsable</a></li>

          <?php endif ?>
        <?php endif ?>
      <?php endif ?>

      <?php if ($orden->estado_id == 2) : ?><!--Asignado-->
      ...
      <?php if ($orden->estado_id == 3) : ?><!--Diagnosticado-->
        <li class="list-inline-item"><a data-toggle="modal" data-target="#modal_add_solicitud_cierre_from_timeline" href="" class="btn btn-default"><span style="color: #160c4e;font-size: 20px;" class="fa fa-telegram"></span>Enviar a Cierre</a></li>
      <?php endif ?>
      <?php if ($orden->estado_id == 5) : ?><!--Esperando cierre-->
        <?php if ($this->session->userdata("rol_id") <= 2) : ?>
...
<div id="Formato ticket_4158" align=center x:publishsource="Excel" class="impresion-ticket">
  ...
  <table border=0 cellpadding=0 cellspacing=0 width=1196 style='border-collapse:
    ...
    <tr height=58 style='mso-height-source:userset;height:43.5pt'>
      ...
      <td align=left valign=top>
        ...
        <span style='mso-ignore:vglayout;
				...
				height:59px'><img width=82 height=59 src="<?php echo base_url() ?>assets/template/logo_hospital.jpg"></span>
      </td>
    ...
    <tr height=22 style='height:16.5pt'>
      ...
      <td colspan=2 class=xl1174158>&nbsp;<?php echo $orden->sede; ?></td>
      <td class=xl664158>Centro de costo</td>
      <td class=xl1204158>&nbsp;<?php echo $orden->centro_costo_reportante; ?></td>
      <td class=xl664158>Servicio</td>
      <td class=xl1204158>&nbsp;<?php echo $orden->servicio; ?></td>
      <td class=xl154158></td>
      <td class=xl734158>O.T. # :</td>
      <td class=xl1004158>&nbsp;<?php echo $orden->id; ?></td>
      <td class=xl754158>&nbsp;</td>
    </tr>
    <tr height=22 style='height:16.5pt'>
      <td height=22 class=xl764158 style='height:16.5pt'>&nbsp;</td>
      <td class=xl744158>Area</td>
      <td colspan=2 class=xl1144158>&nbsp;<?php echo $orden->area; ?></td>
      <td class=xl154158></td>
      <td class=xl154158></td>
      <td class=xl154158></td>
      <td class=xl154158></td>
      ...
      <td class=xl1214158 style='border-top:none'>
        <div class="ajustar-texto">&nbsp;<?php echo $orden->fecha_inicio; ?></div>
      </td>
      <td class=xl754158>&nbsp;</td>
    </tr>
    ...
    <tr class=xl154158 height=21 style='height:15.75pt'>
      <td height=21 class=xl764158 style='height:15.75pt'>&nbsp;</td>
      <?php if ($orden->trabajo_id != 0) : ?>
        <td class=xl844158>
          <strong>TIPO DE ARREGLO</strong>:
        </td>
        <td class=xl844158>
          <?php echo $orden->trabajo; ?>
        </td>
      <?php else : ?>
        <td class=xl844158></td>
        <td class=xl664158></td>
      <?php endif ?>
      <?php if ($orden->listado_industrial_id != 0) : ?>
        <td class=xl664158><strong>TIPO DE EQUIPO</strong></td>
        <td class=xl664158><?php echo $orden->tipo_industrial; ?></td>
      <?php endif ?>
      <td class=xl664158></td>
      <td class=xl664158></td>
      <td class=xl664158></td>
    ...
    <tr height=20 style='height:15.0pt'>
      ...
      <td colspan=4 rowspan=5 class=xl1064158 width=489 style='border-bottom:.5pt solid black;
					width:368pt'>&nbsp;<?php echo $orden->descripcion; ?></td>
      <td colspan=4 rowspan=5 class=xl1054158>&nbsp;

        <?php echo ($orden->subproceso_id != 1) ? "Hospital Universitario del Valle" : $orden->empresa; ?>
        <?php if ($orden->username_usuario_asignador != "") : ?>

          <br>Asignado por: <?php echo $orden->username_usuario_asignador . "<br>(" . $orden->nombre_usuario_asignador . " " . $orden->apellido_usuario_asignador . ")"; ?>
        <?php endif ?>

      </td>
      <td colspan=2 rowspan=2 class=xl984158>&nbsp;
        <?php echo ($orden->tecnico_id != 0) ? $orden->tecnico : $orden->asignado; ?>
        <?php echo $orden->tecnico_otros; ?>
    ...
    <tr height=20 style='height:15.0pt'>
      <td height=20 class=xl764158 style='height:15.0pt'>&nbsp;</td>
      <td colspan=2 rowspan=2 class=xl984158>&nbsp;<div class="ajustar-texto"><?php echo $orden->fecha_asignacion; ?></div>
      </td>
      <td class=xl754158>&nbsp;</td>
    </tr>
    <tr height=20 style='height:15.0pt'>
    ...
    <tr class=xl154158 height=20 style='height:15.0pt'>
      ...
      <td colspan=4 rowspan=4 class=xl1124158 width=489 style='width:368pt'>&nbsp;
        ...
        <div class="row">
          <div class="col-sm-2">
            <?php if ($orden->file_diagnostico != "" && $orden->file_diagnostico != NULL && $orden->file_diagnostico != null) : ?>
              <a style="color: #1c1f23;font-size: 18px;" href="<?php echo base_url(); ?>assets/upload_correctivos_generales/<?php echo $orden->file_diagnostico; ?>" target="__blank" class="fa fa-paperclip"></a>
            <?php endif ?>
          </div>
          <div class="col-sm-10">
            <?php if ($orden->diagnostico != "" && $orden->diagnostico != NULL && $orden->diagnostico != null) : ?>
              <span style="font-weight: 800;">Retro diagnostico:</span><?php echo $orden->retro_diagnostico; ?><p></p><?php echo $orden->diagnostico; ?>
            <?php endif ?>
          </div>
        </div>
      ...
      <td colspan=2 rowspan=4 class="xl1054158 ">&nbsp;<div class="ajustar-texto"><?php echo ($orden->repuesto_pendiente_condicion != "") ? "<strong>Repuesto pendiente?</strong>" : "" ?>&nbsp;<?php echo $orden->repuesto_pendiente_condicion; ?><br><br><?php echo $orden->repuesto_pendiente; ?>
        </div>
      </td>
    ...
    <tr class=xl154158 height=20 style='height:15.0pt'>
      ...
      <td rowspan=2 class=xl974158 width=96 style='border-top:none;width:72pt'>Fecha
        de finalización</td>
      <td rowspan=2 class=xl984158 style='border-top:none'>&nbsp;<div class="ajustar-texto"><?php echo $orden->fecha_diagnostico; ?></div>
      </td>
      <td class=xl754158>&nbsp;</td>
    </tr>
    <tr class=xl154158 height=20 style='height:15.0pt'>
      ...
      <td colspan=4 rowspan=4 class=xl1064158 width=489 style='border-bottom:.5pt solid black;
        ...
        <div class="row">
          <div class="ajustar-texto">
            <div class="col-sm-2">
              <?php if ($orden->file_cierre != "" && $orden->file_cierre != NULL && $orden->file_cierre != null) : ?>
                <a href="<?php echo base_url(); ?>assets/upload_correctivos_generales/<?php echo $orden->file_cierre; ?>" target="__blank" class="fa fa-paperclip" style="color:#1c1f23;font-size: 18px;"></a>
              <?php endif ?>
            </div>
            <div class="col-sm-8">
              <?php if ($orden->retro_cierre != "" && $orden->retro_cierre != null && $orden->retro_cierre != NULL) : ?>
                <span style="font-weight: 800;">Codigo del retro de cierre:</span>
                <?php echo $orden->retro_cierre; ?> <br>
              <?php endif ?>
              <?php echo $orden->reparacion; ?>
            </div>
          </div>
        </div>
      </td>
      <?php if ($orden->subproceso_id != 1) : ?>
        <td colspan=2 rowspan=4 class=xl1054158>&nbsp;<?php echo ($orden->fecha_asignacion_cierre != null && $orden->fecha_asignacion_cierre != "" && $orden->fecha_asignacion_cierre != "0000-00-00") ? $orden->tecnico : ""; ?></td>
      <?php else : ?>
    ...
    <tr class=xl154158 height=20 style='height:15.0pt'>
      ...
      <td rowspan=2 class=xl974158 width=96 style='border-top:none;width:72pt'>Fecha
        de finalización</td>
      <td rowspan=2 class=xl984158 style='border-top:none'>&nbsp;<div class="ajustar-texto"><?php echo $orden->fecha_asignacion_cierre; ?></div>
      </td>
      <td class=xl754158>&nbsp;</td>
    </tr>
    <tr class=xl154158 height=20 style='height:15.0pt'>
          ...
          <tr height=20 style='mso-height-source:userset;height:15.0pt'>
            ...
            <td colspan=9 class=xl1134158 style='border-right:.5pt solid black'>&nbsp;
              <div class="ajustar-texto">
                <div class="row">
                  <div class="col-sm-7">
                    <div class="ajustar-texto"><?php echo $avance->description; ?></div>
                  </div>
                  <div class="col-sm-1">
                  </div>
                  <div class="col-sm-4">
                    <div class="ajustar-texto">
                      <span style="font-size: 10px;" class="text-muted">[<?php echo $avance->date; ?>]</span>
                      <span class="fa fa-user"><?php echo $avance->usuario; ?></span>
                      <?php if ($avance->file != "" && $avance->file != NULL && $avance->file != null) : ?>
                        <a href="<?php echo base_url(); ?>assets/upload_correctivos_generales/<?php echo $avance->file; ?>" target="__blank" class="btn btn-dark fa fa-paperclip"></a>
                      <?php endif ?>
                    </div>
                  </div>
                </div>
  ...
  <tr height=34 style='mso-height-source:userset;height:25.5pt'>
    ...
    <td class=xl664158></td>
    <td colspan=2 class=xl1174158>&nbsp;<?php echo $orden->fecha_asignacion_cierre; ?></td>
    <td class=xl754158>&nbsp;</td>
  </tr>
  <tr height=34 style='mso-height-source:userset;height:25.5pt'>
    <td height=34 class=xl764158 style='height:25.5pt'>&nbsp;</td>
    <td class=xl794158 width=118 style='width:89pt'>Firma de quien cierra la orden:</td>
    <td colspan=4 class=xl1164158 width=490 style='width:368pt'>&nbsp;<div class="ajustar-texto"><?php echo ($orden->usuario_final_id != 0) ? $orden->nombre_usuario_final . " " . $orden->apellido_usuario_final . " (" . $orden->email_usuario_final . ")" : ""; ?></div>
    </td>
    <td class=xl684158 width=119 style='width:89pt'></td>
    <td class=xl664158>Fecha de cierre:</td>
    <td class=xl664158></td>
    <td colspan=2 class=xl1174158>&nbsp;<div class="ajustar-texto"><?php echo $orden->fecha_fin; ?></div>
    </td>
    <td class=xl754158>&nbsp;</td>
  </tr>
  <tr height=20 style='height:15.0pt'>
