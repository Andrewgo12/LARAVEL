								...
								<tr>
									<td style="padding: 20px 0 30px 0;color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
										...
										<blockquote>
											...
											<?php if ($orden->tecnico_diagnostico_text!=null): ?>
											...
											<h4>Informe cierre</h4> <p><?php echo $orden->reparacion; ?></p>	
												<?php if ($orden->tecnico_cierre_text!=null): ?>
												...
												<a href='<?php echo base_url();?>orden/Cordenes/activate/<?php echo $orden->id ?>/<?php echo $orden->code ?>'>Cerrar Orden</a>
