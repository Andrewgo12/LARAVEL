<div class="content-wrapper">
  <section class="content-header">
    ...
    <input class="rol" type="hidden" value=<?= $this->session->userdata("rol_id") ?>>
    <input class="usuario_id" type="hidden" value=<?= $this->session->userdata("id") ?>>
  </section>
...
<script>
  ...
  var rol = "<?= $this->session->userdata("rol_id"); ?>";
  var id_propio = "<?= $this->session->userdata("id"); ?>";
  var controlador = "<?php echo $this->session->userdata('controlador'); ?>";
  var insertar_observacion = "<?php print_r($this->session->userdata('acciones')[17]->insertar); ?>";
  var eliminar_observacion = "<?php print_r($this->session->userdata('acciones')[17]->eliminar); ?>";
  var editar_observacion = "<?php print_r($this->session->userdata('acciones')[17]->editar); ?>";
</script>