							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									<td style="color: #153643; font-family: Arial, sans-serif; font-size: 24px;">
										<b> <h2>Preventivo Nro {{ $preventivo->id }}</h2> </b>
									</td>
								</tr>
								<tr>
									<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
										...
										<ul class="list-inline">
											<li class="list-inline-item">
												...
												<h4>Codigo de preventivo:&nbsp;</h4>{{ $preventivo->description }}
											</li>
											<li class="list-inline-item">
												<strong>Fecha de ejecución</strong>: {{ $preventivo->fecha_mantenimiento }}</footer>
												
											</li>
										</ul>
										@if($preventivo->observacion!=""&&$preventivo->observacion!=null)
											<blockquote>
												
												<h4>Observación</h4>
												<p>{{ $preventivo->observacion }}</p>
