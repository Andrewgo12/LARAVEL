					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								...
								<form action="<?php echo base_url();?>equipo/Cpreventivos/add_nota" id="form_preventivo_nota" name="form_preventivo_nota" enctype="multipart/form-data" method="post">
									<br>
									...
									<div class="row">
										...
										<div class="col-md-6">
											<input type="date" value="<?php echo date("Y-m-d"); ?>" name="fecha_nota" id="fecha_nota" class="form-control" required="">
										</div>
									</div><br>
