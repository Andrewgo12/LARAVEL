                    ...
                    <div class="col-md-12">
                        <div class="box box-info">
                            ...
                            <div class="box-body form-horizontal">
                                ...
                                <form action="{{ asset('') }}correctivo_general/Cavances_correctivos/add" id="form_add_avance_correctivo" name="form_add_avance_correctivo" enctype="multipart/form-data" method="post">
                                    @csrf
                                    <br>
                                    ...
                                    <div class="row">
                                        <div class="row">
                                            <div class="col col-sm-12">
                                                <label for="title" class="badge">Titulo o asunto del avance</label>
