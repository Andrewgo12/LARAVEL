					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								...
								<form action="{{ url('/') }}correctivo_general/Cavances_correctivos/add" id="form_add_avance_correctivo" name="form_add_avance_correctivo" enctype="multipart/form-data" method="post">
									<br>
