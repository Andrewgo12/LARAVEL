      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 table-responsive editarServicio">
            <!--  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
            <form action="<?php echo base_url(); ?>ubicacion/Cservicios/update" id="form_servicio" name="form_servicio" enctype="multipart/form-data" method="post">
...
<script>
  ...
  var eliminar_servicio = "<?php print_r($this->session->userdata('acciones')[2]->eliminar); ?>"; //servicios
  var editar_servicio = "<?php print_r($this->session->userdata('acciones')[2]->editar); ?>"; //servicios
</script>