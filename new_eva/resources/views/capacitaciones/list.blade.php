                  ...
                  <tbody>
                    @foreach($capacitaciones_realizadas as $capacitacion_realizada)
                      <tr>
                        ...
                        <td><a target="__blank" class="glyphicon glyphicon-file" href="{{ url('/') }}/assets/upload_equipo_archivos/<?php echo $capacitacion_realizada->vinculo ?>"></a></td>
                      </tr>
                    <?php endforeach ?>
                  </tbody>
                </table>
                  ...
                  <tbody>
                    @foreach($capacitaciones_archivo as $capacitacion_archivo)
                      <tr>
                        ...
                        <td><a target="__blank" class="glyphicon glyphicon-file" href="{{ url('/') }}/assets/upload_equipo_archivos/<?php echo $capacitacion_archivo->vinculo ?>"></a></td>
