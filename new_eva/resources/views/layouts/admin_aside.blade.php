                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{ url('/'); }}equipo/Cequipos" ?><i class="fa fa-circle-o"></i>Equipos Biomedicos</a></li>
                            <li><a href="{{ url('/'); }}equipos_ind/Cequipos_ind" ?><i class="fa fa-circle-o"></i>Equipos Industriales</a></li>
                            <li><a href="{{ url('/'); }}equipo/Cbajas" ?><i class="fa fa-circle-o"></i>Bajas de equipos biomedicos</a></li>
