...
<head>
  ...
  <!--ligth-box -->
  <link rel="stylesheet" href="{{ url('/') }}plugins/lightbox2-master/dist/css/lightbox.min.css?n={{ time(); }}">  
  <!-- Theme style -->
  <link rel="stylesheet" href="{{ url('/'); }}dist/css/adminlte.min.css">
  <!-- Estilos hoja de vida detalle-->
  <link rel="stylesheet" type="text/css" href="{{ url('/') }}dist/css/hoja_vida/Hoja_de_vida.css?n={{ time(); }}">  
  <!-- Estilos hoja de vida edición-->
  <link rel="stylesheet" type="text/css" href="{{ url('/') }}dist/css/hoja_vida/Hoja_de_vida_edicion.css?n={{ time(); }}">   
  <!-- Bootstrap file -->
  <link rel="stylesheet" href="{{ url('/') }}plugins/bootstrap-file/css/fileinput.min.css">  
