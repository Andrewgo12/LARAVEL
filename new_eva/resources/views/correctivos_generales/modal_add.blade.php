					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								<!--  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
								<form action="{{ url('/') }}equipo/Cequipos/addCorrectivoGeneral" id="form_correctivo_general" name="form_correctivo_general" enctype="multipart/form-data" method="post">
									<br>
									...
									<div class="panel panel-primary">
										...
										<div class="panel-body">
											...
											<div class="row">
												...
												?>
												<div class="col-sm-4">
													<input type="date" name="fecha" id="fecha" min="2015-01-01" max="{{ $fecha_superior }}">
												</div>
											</div>
											<div class="row">
												<div class="row">
