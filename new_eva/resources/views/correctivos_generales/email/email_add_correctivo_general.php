							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									<td style="color: #153643; font-family: Arial, sans-serif; font-size: 24px;">
										<b> <h2>Correctivo general Nro <?php echo $correctivo_general->id; ?></h2> </b>
									</td>
								</tr>
								<tr>
									<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
										...
										<h4>Codigo de orden de trabajo:&nbsp;</h4><?php echo $correctivo_general->code_orden; ?>
										<blockquote>
											<h4>Descripcion</h4>
											<p><?php echo $correctivo_general->orden; ?></p>
											<footer style="font-size: 10px;"><strong>Fecha de registro</strong>: <?php echo $correctivo_general->fecha_inicio; ?></footer>
										</blockquote>
										<blockquote>
											<h4>Ubicación de referencia</h4>
											<p><?php echo $equipo->servicios; ?></p>
											<?php if ($equipo->area!=""&&$equipo->area!="null"): ?>
												<footer style="font-size: 10px;"><strong>Area</strong>: <?php echo $equipo->area; ?></footer>
											<?php endif ?>
										</blockquote>
										...
										<?php if (isset($equipo)): ?>
											...
											<ul class="list-inline">
												<li class="list-inline-item">
													<?php echo $correctivo_general->repuesto_id; ?>
												</li>
											</ul>
