<div id="modal_add_area" class="modal fade" role="dialog">
					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								<form action="" name="form_add_area" class="form_add_area" enctype="multipart/form-data" method="post" onsubmit="(new areaObj).HandleSubmitInsert(event)">
