    ...
    <div class="box box-solid">
      <div class="box-body">
        <?php foreach ($acciones as $accion) : ?>
          <?php if ($accion->modulo == "guias rapidas" && $accion->insertar == 1) : ?>
              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="table-responsive">
                    <input id="controlador" type="hidden" value="<?php echo $this->session->userdata('controlador'); ?>">
                    ...
                    <a href="<?php echo base_url(); ?>guia/Cguias/exportarPriorizados" class="btn btn-success fa fa-file">Exportar Priorizados</a>
                    <a href="<?php echo base_url(); ?>guia/Cguias/exportarPriorizadosGuia" class="btn btn-success fa fa-file">Exportar Priorizados con guia rapida</a>
                    <a href="<?php echo base_url(); ?>guia/Cguias/exportPrioritizedWithoutGuide" class="btn btn-success fa fa-file">Exportar Priorizados sin guia rapida</a>
                    <a href="<?php echo base_url(); ?>guia/Cguias/exportarPriorizadosGrupo" class="btn btn-success fa fa-file">Exportar Priorizados por grupo</a>
