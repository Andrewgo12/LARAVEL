					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								...
								<form action="{{ asset('') }}equipos_ind/Cequipos_ind/updatePreventivo" id="form_update_preventivo" name="form_update_preventivo" enctype="multipart/form-data" method="post">
      @csrf
									<br>
