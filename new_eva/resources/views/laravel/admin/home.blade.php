    ...
    <div class="row">
                    ...
                    @foreach($guias as $guia)
                      @if($guia->id != 0)
                        <tr>
                          ...
                          <td>
                            {{ $guia->name }}
                            <a class="glyphicon glyphicon-paperclip updateCounter" data-id={{ $guia->id }} target=" __blank" href="<?php echo {{ asset('assets/upload_guias/') }} . $guia->file; ?>">
                            </a>
                          </td>
                          <td>
                            {{ $guia->totalQuery }}
      ...
      <div class="col-lg-6">
        <video width="100%" controls autoplay>
          <source src="<?php echo {{ asset('assets/upload_guias/') }}; ?>CUIDADO Y LIMPIEZA.mp4" type="video/mp4">
        </video>
      </div>
      <div class="col-sm-4">
      </div>
...
<script>
  ...
  let controlador = "<?php echo session('controlador'); ?>";
