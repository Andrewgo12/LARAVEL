							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
										...
										<ul>
											<li><div style="font-family: serif;font-weight: 800">Nombre de usuario : </div>: {{ $usuario->username }}</li>
											<li><div style="font-family: serif;font-weight: 800">Email</div>: {{ $usuario->email }}</li>
											<li><div style="font-family: serif;font-weight: 800">Contraseña</div>: {{ $password }}</li>
											<li><div style="font-family: serif;font-weight: 800">centro de costo: </div>: {{ $usuario->centro }}</li>
