								...
								<div class="text-center">
									<ul>
										@foreach($archivos as $archivo_singular)
											<li >
												{{ $archivo_singular->archivo }}<a target="__blank" class="glyphicon glyphicon-file esconder" href="<?=base_url();?>assets/upload_equipo_archivos/{{ $archivo_singular->vinculo }}"></a>
											</li>
										<?php endforeach ?>				
									</ul>
								</div>
