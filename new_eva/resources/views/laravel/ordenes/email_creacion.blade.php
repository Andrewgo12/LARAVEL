								...
								<tr>
									<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
										...
										<?php if (isset($equipo)): ?>
											...
											@if($orden->nombre_reportante!=null&&$orden->nombre_reportante!="")
											<blockquote>
												<h4>Usuario administrador que registra la orden</h4>
											</blockquote>												
											<ul>
												<li><strong>Nombre</strong>: <?php echo   session('nombre');?> </li>
												<li><strong>Apellido</strong>: <?php echo session('apellido');?></li>
												<li><strong>Telefono</strong>: <?php echo session('telefono');?></li>
												<li><strong>Email</strong>: <?php echo    session('email');?></li>
											</ul>
											<blockquote>
