...
<div id="Formato ticket_4158" align=center x:publishsource="Excel" class="impresion-ticket">
  ...
  <table border=0 cellpadding=0 cellspacing=0 width=1196 style='border-collapse:
    ...
    <tr class=xl154158 height=20 style='height:15.0pt'>
      ...
      <td colspan=2 rowspan=4 class="xl1054158 ">&nbsp;<div class="ajustar-texto"><?php echo ($orden->repuesto_pendiente_condicion != "") ? "<strong>Repuesto pendiente?</strong>" : "" ?>&nbsp;{{ $orden->repuesto_pendiente_condicion }}<br><br>{{ $orden->repuesto_pendiente }}
        </div>
      </td>
