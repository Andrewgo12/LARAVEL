...
<head>
  ...
  <meta http-equiv="content-type" content="text/html; charset=windows-1252" />
   <link rel="stylesheet" href="{{ url('/') }}/style/style.css" type="text/css"></link>
    </head>
  ...
  <div id="main">
    ...
    <div id="site_content">
      ...
      <div id="content">
          ...
          <tr><td>Nombre :   </td><td>{{ "".$dato->nombre }}</td></tr>      
          <tr><td>Marca  :   </td><td>{{ "".$dato->marca }}</td></tr>
          <tr><td>Serial :   </td><td>{{ "".$dato->serial }}</td></tr>
          <tr><td>Servicio : </td><td>{{ "".$dato->name }}</td></tr>
          <tr><td>Periodicidad Mantenimiento : </td><td>{{ "".$dato->namem }}</td></tr>
         </table>
         ...
         <img src="{{ url('/') }}/style/imagenes_equipos_industriales/<?php echo $dato->imagen ?>" style="width:274px;height:190px;"> 
         </form>
