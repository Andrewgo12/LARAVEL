<html>
	<table class="datatable-invimas" border="1">
		...
		<tbody>
			...
			<?php foreach ($invimas as $invima): ?>
			<tr>
				<td>
					<span class="btn btn-info" onclick="asociar_registro('<?php echo $invima->id;?>')">Seleccionar</span>
					<?php echo $invima->invima; ?>
					<?php if ($invima->file!=null&$invima->file!=""): ?>
							<a target="__blank" class="glyphicon glyphicon-file" href="<?php echo base_url();?>assets/upload_registros_sanitarios/<?php echo $invima->file;?>"></a>
						<?php endif ?>	
