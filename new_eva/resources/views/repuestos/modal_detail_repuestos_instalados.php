...
<a href="<?php echo base_url(); ?>repuesto/Crepuestos/excel_repuestos_instalados" class="" target="__blank" >Exportar</a>
<table style="width: 70%;" class="table table-condensed table-bordered  tbl_repuestos_instalados">
	...
	<tbody>
		<?php foreach ($repuestos_instalados as $repuesto_instalado): ?>
			<tr>
