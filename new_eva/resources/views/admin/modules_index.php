...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="<?= base_url(); ?>ci/home"><i class="fa fa-dashboard"></i> Inicio</a></li>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="list-group">
                                    <a href="<?= base_url(); ?>ci/equipos" class="list-group-item">
                                        <i class="fa fa-cogs"></i> Equipos Biomédicos
                                    </a>
                                    <a href="<?= base_url(); ?>ci/ordenes" class="list-group-item">
                                        <i class="fa fa-ticket"></i> Órdenes de Trabajo
                                    </a>
                                    <a href="<?= base_url(); ?>ci/preventivos" class="list-group-item">
                                        <i class="fa fa-calendar"></i> Mantenimientos Preventivos
                                    </a>
                                    <a href="<?= base_url(); ?>ci/calibraciones" class="list-group-item">
                                        <i class="fa fa-balance-scale"></i> Calibraciones
                                    </a>
                                    <a href="<?= base_url(); ?>ci/repuestos" class="list-group-item">
                                        <i class="fa fa-puzzle-piece"></i> Repuestos
                                    </a>
                                    <a href="<?= base_url(); ?>ci/usuarios" class="list-group-item">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="list-group">
                                    <a href="<?= base_url(); ?>ci/tecnicos" class="list-group-item">
                                        <i class="fa fa-user-md"></i> Técnicos
                                    </a>
                                    <a href="<?= base_url(); ?>ci/servicios" class="list-group-item">
                                        <i class="fa fa-hospital-o"></i> Servicios
                                    </a>
                                    <a href="<?= base_url(); ?>ci/areas" class="list-group-item">
                                        <i class="fa fa-building"></i> Áreas
                                    </a>
                                    <a href="<?= base_url(); ?>ci/categorias" class="list-group-item">
                                        <i class="fa fa-tags"></i> Categorías
                                    </a>
                                    <a href="<?= base_url(); ?>ci/contactos" class="list-group-item">
                                        <i class="fa fa-phone"></i> Contactos
                                    </a>
                                    <a href="<?= base_url(); ?>ci/propietarios" class="list-group-item">
                                        <i class="fa fa-user"></i> Propietarios
                                    </a>
                                    <a href="<?= base_url(); ?>ci/mantenimientos" class="list-group-item">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="list-group">
                                    <a href="<?= base_url(); ?>ci/invimas" class="list-group-item">
                                        <i class="fa fa-certificate"></i> INVIMA
                                    </a>
                                    <a href="<?= base_url(); ?>ci/ordenes_compra" class="list-group-item">
                                        <i class="fa fa-shopping-cart"></i> Órdenes de Compra
                                    </a>
                                    <a href="<?= base_url(); ?>ci/manuales" class="list-group-item">
                                        <i class="fa fa-book"></i> Manuales
                                    </a>
                                    <a href="<?= base_url(); ?>ci/guias" class="list-group-item">
                                        <i class="fa fa-file-text"></i> Guías Rápidas
                                    </a>
                                    <a href="<?= base_url(); ?>ci/bajas" class="list-group-item">
                                        <i class="fa fa-trash"></i> Bajas de Equipos
                                    </a>
                                    <a href="<?= base_url(); ?>ci/archivos" class="list-group-item">
                                        <i class="fa fa-folder"></i> Archivos
                                    </a>
                                    <a href="<?= base_url(); ?>ci/reportes" class="list-group-item">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <a href="<?= base_url(); ?>ci/equipos_industriales" class="btn btn-default btn-block">
                                            <i class="fa fa-industry"></i> Equipos Industriales
                                        </a>
                                    </div>
                                    <div class="col-md-3">
                                        <a href="<?= base_url(); ?>ci/correctivos_generales" class="btn btn-default btn-block">
                                            <i class="fa fa-tools"></i> Correctivos Generales
                                        </a>
                                    </div>
                                    <div class="col-md-3">
                                        <a href="<?= base_url(); ?>ci/contingencias" class="btn btn-default btn-block">
                                            <i class="fa fa-exclamation-triangle"></i> Contingencias
                                        </a>
                                    </div>
                                    <div class="col-md-3">
                                        <a href="<?= base_url(); ?>ci/capacitaciones" class="btn btn-default btn-block">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <a href="<?= base_url(); ?>ci/cambios_ubicaciones" class="btn btn-default btn-block">
                                            <i class="fa fa-exchange"></i> Cambios Ubicaciones
                                        </a>
                                    </div>
                                    <div class="col-md-3">
                                        <a href="<?= base_url(); ?>ci/avances_correctivos" class="btn btn-default btn-block">
                                            <i class="fa fa-progress"></i> Avances Correctivos
                                        </a>
                                    </div>
                                    <div class="col-md-3">
                                        <a href="<?= base_url(); ?>ci/estadoequipos" class="btn btn-default btn-block">
                                            <i class="fa fa-info-circle"></i> Estado Equipos
                                        </a>
                                    </div>
                                    <div class="col-md-3">
                                        <a href="<?= base_url(); ?>ci/repuestos_pendientes" class="btn btn-default btn-block">
                        ...
                        <div class="alert alert-info">
                            ...
                            <p><strong>Usuario actual:</strong> <?= $this->session->userdata('nombre'); ?> (<?= $this->session->userdata('email'); ?>)</p>
                        </div>

                        <!-- Enlaces de navegación -->
                        <div class="text-center">
                            <a href="<?= base_url(); ?>ci/home" class="btn btn-primary">
                                <i class="fa fa-home"></i> Volver al Inicio
                            </a>
                            <a href="<?= base_url(); ?>" class="btn btn-info">
                                <i class="fa fa-laravel"></i> Laravel App
                            </a>
                            <a href="<?= base_url(); ?>test-db" class="btn btn-warning">
