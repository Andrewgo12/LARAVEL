<div class="" style="overflow-x: auto;">
	<a class="btn btn-info" href="<?php echo base_url();?>equipo/Cequipos/ConsolidadoObsoletos" target="_blank">Exportar Consolidado</a><br><br>
	<table class="datatable-obsoletos table">
		...
		<tbody>
			<?php foreach ($obsoletos as $obsoleto): ?>
				<tr>
