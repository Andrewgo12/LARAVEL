					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								...
								<form action="<?php echo base_url();?>equipo/Cequipos/addArchivoCorrectivoGeneral" id="form_archivo_correctivo_general" name="form_archivo_correctivo_general" enctype="multipart/form-data" method="post">
									<br>
