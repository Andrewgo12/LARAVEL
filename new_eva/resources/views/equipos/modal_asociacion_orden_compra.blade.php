<div class="modal fade" id="modal_asociacion_orden_compra">
  <div class="modal-dialog" style="width:90%;">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="" class="form_asociacion_orden_compra_equipos" id="form_asociacion_orden_compra_equipos" name="form_asociacion_orden_compra_equipos" enctype="multipart/form-data" method="post">
