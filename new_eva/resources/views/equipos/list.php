            ...
            <div class="panel panel-default">
              <div class="panel-body">
                <ul class="list-inline section-filter-navbar">
                  ...
                  <li class="list-inline-item custom-btn"><a class="btn btn-default" href="<?php echo base_url(); ?>equipo/Cequipos/Exportar_cantidades" target="_blank">Month</a>
                  </li>
                </ul>
              </div>
            </div>
...
<script>
  ...
  var sede_id = "<?php echo $this->session->userdata('sede_id'); ?>";


  var insertar_equipo = "<?php print_r($this->session->userdata('acciones')[0]->insertar); ?>"; //equipos
  ...
  var insertar_area = "<?php print_r($this->session->userdata('acciones')[19]->insertar); ?>"; //areas
  var editar_area = "<?php print_r($this->session->userdata('acciones')[19]->editar); ?>"; //areas
  var eliminar_area = "<?php print_r($this->session->userdata('acciones')[19]->eliminar); ?>"; //areas

  var insertar_contingencia = "<?php print_r($this->session->userdata('acciones')[20]->insertar); ?>"; //contingencias
  var eliminar_contingencia = "<?php print_r($this->session->userdata('acciones')[20]->eliminar); ?>"; //contingencias
  var editar_contingencia = "<?php print_r($this->session->userdata('acciones')[20]->editar); ?>"; //contingencias
