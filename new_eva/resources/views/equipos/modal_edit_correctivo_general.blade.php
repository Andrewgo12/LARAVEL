					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								...
								<form action="{{ url('/') }}equipo/Cequipos/updateCorrectivoGeneral" id="form_update_correctivo_general" name="form_update_correctivo_general" enctype="multipart/form-data" method="post">
									<br>
