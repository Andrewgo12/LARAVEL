					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								...
								<form action="{{ url('/') }}equipos/Cequipos/updateEquipoRepuesto" id="form_update_equipo_repuesto" name="form_update_equipo_repuesto" enctype="multipart/form-data" method="post">
									<br>
