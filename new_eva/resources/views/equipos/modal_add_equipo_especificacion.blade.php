					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								...
								<form action="{{ url('/') }}equipo/Cequipos/addEquipoEspecificacion" id="form_equipo_especificacion" name="form_equipo_especificacion" enctype="multipart/form-data" method="post">
									<br>
