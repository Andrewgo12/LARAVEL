				...
				<div class="row">
					<div class="col-md-12">
						<div class="box box-info">
							...
							<form action="<?php echo base_url(); ?>equipo/Cequipos/addEquipoRepuesto" id="form_repuesto_correctivo_general" name="form_repuesto_correctivo_general" enctype="multipart/form-data" method="post">
								<br>
