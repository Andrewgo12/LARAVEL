...
<div class="row">
	<div class="col-md-3">
		<strong style="text-transform: uppercase;">Cantidad de registros encontrados:</strong>&nbsp;<span style="color: red;"><?php echo $cantidad; ?></span>
	</div>
	<div class="col-md-3">
		<strong style="text-transform: uppercase;">Inversion:</strong>&nbsp;<span style="color: red;font-weight: 800;"><?php echo $inversion; ?></span>
	</div>	
	<div class="col-md-6">
		<?php if ($this->session->userdata("sede_id")==1): ?>
			<strong style="text-transform: uppercase;">Sede:</strong>&nbsp;<span style="color: red;">PRINCIPAL</span>
		<?php endif ?>
		<?php if ($this->session->userdata("sede_id")==2): ?>
			<strong style="text-transform: uppercase;">Sede:</strong>&nbsp;<span style="color: red;">NORTE</span>
		<?php endif ?>
		<?php if ($this->session->userdata("sede_id")==""): ?>
		...
		<div id="nav_instalacion_distribucion_tipo_adquisicion" class="tab-pane fade">
			<div class="">
				...
				<table border="0" class=" table">
					...
					<tbody>
						<?php foreach ($tipos_adquisicion as $tipo_adquisicion): ?>
							<tr>
								<td>
									<div class="notification">
