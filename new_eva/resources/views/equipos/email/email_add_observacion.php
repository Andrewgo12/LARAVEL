							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									<td style="color: #153643; font-family: Arial, sans-serif; font-size: 24px;">
										<b> <h2>Observación Nro <?php echo $observacion->id; ?></h2> </b>
									</td>
								</tr>
								<tr>
									<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
										...
										<blockquote>
											<h4>Descripcion</h4>
											<p><?php echo $observacion->description; ?></p>
											<footer style="font-size: 10px;"><strong>Fecha de registro</strong>: <?php echo $observacion->created_at; ?></footer>
										</blockquote>
										<blockquote>
										...
										<?php if (isset($equipo)): ?>
											...
											<ul class="list-inline">
												<li class="list-inline-item">
													<?php echo $observacion->repuesto_id; ?>
												</li>
											</ul>
