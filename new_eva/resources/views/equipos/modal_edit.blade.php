					...
					<div class="col-md-12">
						<div class="box box-info">
							...
							<div class="box-body form-horizontal">
								...
								<!--  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
								<form action="{{ url('/') }}equipo/Cequipos/update" id="form_update_equipo" name="form_update_equipo" enctype="multipart/form-data" method="post">
										...
										<div class="tg-wrap">
											<table class="tg">
												...
												<tr>
													...
													<td class="tg-0pky" colspan="2">
														<!-- 														<input type="date" min="1950-01-31" max="{{ date('Y-m-d') }}" class="form-control" name="fecha_ad" id="fecha_ad"> -->
