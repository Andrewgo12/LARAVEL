        ...
        <div class="modal-body"> 
          ...
          <div class="tab-content">
            <div id="nav_capacitaciones" class="tab-pane fade in active">
              ...
              <form action="<?php echo url('/') ?>equipo/Cequipos/addMultipleCapacitaciones" id="multiple_capacitaciones" enctype="multipart/form-data" method="post">
            ...
            <div id="nav_especificaciones" class="tab-pane fade">
              <form action="<?php echo url('/') ?>equipo/Cequipos/addMultipleEspecificaciones" id="multiple_especificaciones" name="multiple_especificaciones" enctype="multipart/form-data" method="post">
          ...
          <div id="nav_imagenes" class="tab-pane fade">
            ...
            <form action="<?php echo url('/') ?>equipo/Cequipos/addMultipleImagenes" id="multiple_imagenes" name="multiple_imagenes" enctype="multipart/form-data" method="post">
