								...
								<div class="col-md-3">
									...
									<ul class="list-inline">
										<li class="list-inline-item">
											Fecha inicial
											<input value="{{ date('Y-m-d') }}" class="form-control inicial-adquisicion" type="date">
										</li>
										<li class="list-inline-item">
											Fecha final
											<input value="{{ date('Y-m-d') }}" class="form-control final-adquisicion" type="date"></li>
									...
									<div class="col-md-3">
										...
										<ul class="list-inline">
											<li class="list-inline-item">
												Fecha inicial									
												<input value="{{ date('Y-m-d') }}" class="form-control inicial-instalacion" type="date"></li>
												<li class="list-inline-item">
													Fecha final									
													<input value="{{ date('Y-m-d') }}" class="form-control final-instalacion" type="date"></li>
