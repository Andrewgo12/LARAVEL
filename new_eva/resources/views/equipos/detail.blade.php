...
?>
  <a onclick="show_cambios_hdv({{ $equipo->id }})" title="Historial de cambios" href="#" data-toggle="modal" data-target="#modal_show_cambios_hdv" class="fa fa-caret-square-o-right btn btn-success">Historial</a>
<?php
}
?>
<div id="contenedor_detalle_equipo" x:publishsource="Excel" class="impresion">
  <table cellpadding=0 cellspacing=0 width=832 class="tabla_detalles" style='border-collapse:
    ...
    <tr height=61 style='height:45.75pt'>
      ...
      <td colspan=5 class=xl9426419 width=118 style='width:89pt'>&nbsp;<img src="{{ url('/'); }}assets/template/logo_hospital.jpg" width="170px;" height="100px;"></td>
    ...
    <tr height=31 style='height:23.25pt'>
      ...
      <td class=xl6426419 width=39 style='width:29pt'>&nbsp;{{ $equipo->id }}</td>
    ...
    <tr height=24 style='height:18.0pt'>
      ...
      <td colspan=17 rowspan=12 class=xl9626419 width=309 style='border-right:1.0pt solid black;
						border-bottom:1.0pt solid black;width:234pt'>&nbsp;<img class="" width="350px" height="280px" src="{{ url('/') }}assets/upload_imagenes/{{ $equipo->image }}" alt=""></td>
      <td class=xl1526419></td>
    </tr>
    <tr height=21 style='height:15.75pt'>
      ...
      <td colspan=33 class=xl10526419 width=337 style='border-right:1.0pt solid black;
						border-left:none;width:259pt'>&nbsp;{{ $equipo->serial != '' ? $equipo->serial : 'No registra' }}</td>
      <td class=xl1526419></td>
    </tr>
    <tr height=22 style='height:16.5pt'>
      ...
      <td colspan=13 class=xl7526419 width=112 style='border-right:1.0pt solid black;
						border-left:none;width:88pt'>&nbsp;{{ $equipo->codigo_antiguo }}</td>
      ...
      <td colspan=7 class=xl7526419 width=79 style='border-right:1.0pt solid black;
						border-left:none;width:60pt'>&nbsp;{{ $equipo->code }}</td>
      <td class=xl1526419></td>
    </tr>
    <tr height=21 style='height:15.75pt'>
      ...
      <td colspan=35 class=xl7526419 width=361 style='border-right:1.0pt solid black;
						border-left:none;width:277pt'>&nbsp;{{ $equipo->marca }}</td>
      <td class=xl1526419></td>
    </tr>
    <tr height=21 style='height:15.75pt'>
      <td colspan=2 height=21 class=xl7526419 width=82 style='border-right:1.0pt solid black;
      ...
      <td colspan=35 class=xl6626419 width=361 style='border-right:1.0pt solid black;
						border-left:none;width:277pt'>&nbsp;{{ $equipo->modelo }}</td>
      <td class=xl1526419></td>
    </tr>
    <tr height=21 style='height:15.75pt'>
      <td colspan=2 height=21 class=xl7526419 width=82 style='border-right:1.0pt solid black;
      ...
      <td colspan=35 class=xl13626419 width=361 style='border-right:1.0pt solid black;
        ...
        @if($equipo->registro_sanitario != null)
          <span title="{{ $equipo->registro_sanitario_descripcion }}">
            {{ $equipo->registro_sanitario }}
          </span>
          <a target="__blank" class="glyphicon glyphicon-file esconder" href="{{ url('/') }}assets/upload_registros_sanitarios/{{ $equipo->file_registro_sanitario }}"></a>
        @else
          {{ $equipo->invima }}
          @if($equipo->archivo_invima != null)
            <a target="__blank" class="glyphicon glyphicon-file esconder" href="{{ url('/') }}assets/upload_invimas/{{ $equipo->archivo_invima }}"></a>
          <?php endif ?>
        <?php endif ?>
      </td>
      <td class=xl1526419></td>
    ...
    <tr height=21 style='height:15.75pt'>
      ...
      <td colspan=35 class=xl6926419 width=361 style='border-right:1.0pt solid black;
        ...
        <strong>Servicio:</strong>&nbsp;{{ $equipo->servicios }}<br>
        @if($equipo->area != "" && $equipo->area != null)
          <strong>Area:</strong>
          &nbsp;<small class="text-muted">{{ $equipo->area }}</small>
        <?php endif ?>
      </td>
      <td class=xl1526419></td>
    </tr>
    <tr height=20 style='height:15.0pt'>
      ...
      <td colspan=15 class=xl8926419 width=142 style='border-right:1.0pt solid black;
						width:110pt'>&nbsp;{{ ($equipo->pisos_areas == "" || $equipo->pisos_areas == "NULL" || $equipo->pisos_areas == "null") ? $equipo->pisos : $equipo->pisos_areas }}</td>
      ...
      <td colspan=7 class=xl6926419 width=79 style='border-right:1.0pt solid black;
						border-left:none;width:60pt'>&nbsp;{{ $equipo->centro }}</td>
      <td class=xl1526419></td>
    </tr>
    <tr height=20 style='height:15.0pt'>
      ...
      <td colspan=15 class=xl7926419 width=142 style='border-right:1.0pt solid black;
						border-left:none;width:110pt'>&nbsp;{{ $equipo->movilidad }}</td>
      <td colspan=13 class=xl8226419 width=140 style='border-right:1.0pt solid black;
    ...
    <tr height=21 style='height:15.75pt'>
      ...
      <td colspan=28 class=xl11726419 width=272 style='border-right:1.0pt solid black;
						border-left:none;width:209pt'>&nbsp;{{ $equipo->activo_comodato }}</td>
      <td class=xl1526419></td>
    </tr>
    <tr height=21 style='height:15.75pt'>
      ...
      <td colspan=15 class=xl11826419 width=140 style='border-right:1.0pt solid black;
						border-left:none;width:109pt'>&nbsp;{{ ($equipo->fecha_ad == "0000-00-00" || $equipo->fecha_ad == "" || $equipo->fecha_ad == null) ? "SIN INFORMACIÓN" : $equipo->fecha_ad }}</td>
      ...
      <td colspan=8 class=xl11826419 width=171 style='border-right:1.0pt solid black;
						border-left:none;width:129pt'>&nbsp;{{ ($equipo->fecha_acta_recibo == "0000-00-00" || $equipo->fecha_acta_recibo == "" || $equipo->fecha_acta_recibo == null) ? "SIN INFORMACIÓN" : $equipo->fecha_acta_recibo }}</td>
      <td class=xl1526419></td>
    </tr>
    <tr height=21 style='height:15.75pt'>
      <td colspan=11 height=21 class=xl7526419 width=173 style='border-right:1.0pt solid black;
      ...
      <td colspan=15 class=xl11826419 width=140 style='border-right:1.0pt solid black;
						border-left:none;width:109pt'>&nbsp;{{ ($equipo->fecha_instalacion == "0000-00-00" || $equipo->fecha_instalacion == "" || $equipo->fecha_instalacion == null) ? "SIN INFORMACIÓN" : $equipo->fecha_instalacion }}</td>
      <td colspan=20 class=xl7526419 width=268 style='border-right:1.0pt solid black;
						border-left:none;width:203pt'>2.5 Fecha de inicio de operación:</td>
      <td colspan=8 class=xl11826419 width=171 style='border-right:1.0pt solid black;
						border-left:none;width:129pt'>&nbsp;{{ ($equipo->fecha_inicio_operacion == "0000-00-00" || $equipo->fecha_inicio_operacion == "" || $equipo->fecha_inicio_operacion == null) ? "SIN INFORMACIÓN" : $equipo->fecha_inicio_operacion }}</td>
      <td class=xl1526419></td>
    </tr>
    <tr height=21 style='height:15.75pt'>
      <td colspan=11 height=21 class=xl7526419 width=173 style='border-right:1.0pt solid black;
      ...
      <td colspan=15 class=xl11826419 width=140 style='border-right:1.0pt solid black;
						border-left:none;width:109pt'>&nbsp;{{ ($equipo->fecha_vencimiento_garantia == "0000-00-00" || $equipo->fecha_vencimiento_garantia == "" || $equipo->fecha_vencimiento_garantia == null) ? "SIN INFORMACIÓN" : $equipo->fecha_vencimiento_garantia }}</td>
      <td colspan=20 class=xl7526419 width=268 style='border-right:1.0pt solid black;
						border-left:none;width:203pt'>2.7 Fecha de fabricación:</td>
      <td colspan=8 class=xl11826419 width=171 style='border-right:1.0pt solid black;
						border-left:none;width:129pt'>&nbsp;{{ ($equipo->fecha_fabricacion == "0000-00-00" || $equipo->fecha_fabricacion == "" || $equipo->fecha_fabricacion == null) ? "SIN INFORMACIÓN" : $equipo->fecha_fabricacion }}</td>
      <td class=xl1526419></td>
    </tr>
    <tr height=21 style='height:15.75pt'>
      <td colspan=11 height=21 class=xl7526419 width=173 style='border-right:1.0pt solid black;
      ...
      <td colspan=43 class=xl11826419 width=579 style='border-right:1.0pt solid black;
						border-left:none;width:441pt'>&nbsp;{{ ($equipo->fecha_recepcion_almacen == "0000-00-00" || $equipo->fecha_recepcion_almacen == "" || $equipo->fecha_recepcion_almacen == null) ? "SIN INFORMACIÓN" : $equipo->fecha_recepcion_almacen }}</td>
      <td class=xl1526419></td>
    </tr>
    <tr height=21 style='height:15.75pt'>
      ...
      <td colspan=37 class=xl15326419 width=374 style='border-right:1.0pt solid black;
        ...
        <span class="clase_costo">{{ $equipo->costo }}</span>
      </td>
      ...
      <td colspan=8 class=xl12326419 width=171 style='border-right:1.0pt solid black;
						border-left:none;width:129pt'>&nbsp;{{ $equipo->vida_util }}</td>
      <td class=xl1526419></td>
    </tr>
    <tr height=21 style='height:15.75pt'>
      <td colspan=27 height=21 class=xl7526419 width=321 style='border-right:1.0pt solid black;
						height:15.75pt;width:246pt'>PROVEEDOR:&nbsp;{{ (isset($proveedor->contacto) ? $proveedor->contacto : "") }}<span>  </span></td>
      <td colspan=15 class=xl14126419 width=192 style='border-right:1.0pt solid black;
						border-left:none;width:145pt'>TEL:{{ (isset($proveedor->telefono) ? $proveedor->telefono : "") }}</td>
      <td colspan=12 class=xl14726419 width=239 style='border-right:1.0pt solid black;
						border-left:none;width:181pt'>EMAIL:{{ (isset($proveedor->email) ? $proveedor->email : "") }}</td>
      <td class=xl1526419></td>
    </tr>
    <tr height=21 style='height:15.75pt'>
      <td colspan=27 height=21 class=xl8226419 width=321 style='border-right:1.0pt solid black;
						height:15.75pt;width:246pt'>REPRESENTANTE:&nbsp;{{ (isset($representante->contacto) ? $representante->contacto : "") }}<span> </span></td>
      <td colspan=15 class=xl6926419 width=192 style='border-right:1.0pt solid black;
						border-left:none;width:145pt'>TEL:{{ (isset($representante->telefono) ? $representante->telefono : "") }}</td>
      <td colspan=12 class=xl8226419 width=239 style='border-right:1.0pt solid black;
						border-left:none;width:181pt'>EMAIL:{{ (isset($representante->email) ? $representante->email : "") }}</td>
      <td class=xl1526419></td>
    </tr>
    <tr height=21 style='height:15.75pt'>
      <td colspan=27 height=21 class=xl8526419 width=321 style='border-right:1.0pt solid black;
						height:15.75pt;width:246pt'>FABRICANTE:&nbsp;{{ (isset($fabricante->contacto) ? $fabricante->contacto : "") }}<span> </span></td>
      <td colspan=15 class=xl14426419 width=192 style='border-right:1.0pt solid black;
						border-left:none;width:145pt'>TEL:{{ (isset($fabricante->telefono) ? $fabricante->telefono : "") }}</td>
      <td colspan=12 class=xl8526419 width=239 style='border-right:1.0pt solid black;
						border-left:none;width:181pt'>EMAIL:{{ (isset($fabricante->email) ? $fabricante->email : "") }}</td>
      <td class=xl1526419></td>
    </tr>
    ...
    <tr height=27 style='height:20.25pt'>
      ...
      <td colspan=42 class=xl11426419 width=573 style='border-right:1.0pt solid black;
					border-left:none;width:436pt'>&nbsp;{{ $equipo->fuentes }}</td>
      <td class=xl1526419></td>
    </tr>
    <tr height=24 style='height:18.0pt'>
      ...
      <td colspan=42 class=xl11826419 width=573 style='border-right:1.0pt solid black;
					border-left:none;width:436pt'>&nbsp;{{ $equipo->tecnologias }}</td>
      <td class=xl1526419></td>
    </tr>
    <tr height=24 style='height:18.0pt'>
      <td colspan=12 height=24 class=xl8226419 width=179 style='border-right:1.0pt solid black;
      ...
      <td colspan=42 class=xl11826419 width=573 style='border-right:1.0pt solid black;
					border-left:none;width:436pt'>&nbsp;{{ (isset($tension->valor) ? $tension->valor : " NO APLICA") }}</td>
      <td class=xl1526419></td>
    </tr>
    <tr height=24 style='height:18.0pt'>
      <td colspan=12 height=24 class=xl8226419 width=179 style='border-right:1.0pt solid black;
      ...
      <td colspan=42 class=xl11826419 width=573 style='border-right:1.0pt solid black;
					border-left:none;width:436pt'>&nbsp;{{ (isset($temperatura->valor) ? $temperatura->valor : " NO APLICA") }}</td>
      <td class=xl1526419></td>
    </tr>
    <tr height=24 style='height:18.0pt'>
      <td colspan=12 height=24 class=xl8226419 width=179 style='border-right:1.0pt solid black;
      ...
      <td colspan=42 class=xl11826419 width=573 style='border-right:1.0pt solid black;
					border-left:none;width:436pt'>&nbsp;{{ (isset($humedad->valor) ? $humedad->valor : " NO APLICA") }}</td>
      <td class=xl1526419></td>
    </tr>
    <tr height=24 style='height:18.0pt'>
      <td colspan=12 height=24 class=xl8226419 width=179 style='border-right:1.0pt solid black;
      ...
      <td colspan=42 class=xl11826419 width=573 style='border-right:1.0pt solid black;
					border-left:none;width:436pt'>&nbsp;{{ (isset($frecuencia->valor) ? $frecuencia->valor : " NO APLICA") }}</td>
      <td class=xl1526419></td>
    </tr>
    <!-- <tr height=21 style='height:15.75pt'>
      ...
      <td colspan=22 class=xl8226419 width=189 style='border-right:1.0pt solid black;
					border-left:none;width:147pt'>&nbsp;{{ (isset($tension->valor) ? $tension->valor : " NO APLICA") }}</td>
      ...
      <td colspan=11 class=xl8226419 width=222 style='border-right:1.0pt solid black;
					border-left:none;width:168pt'>&nbsp;{{ (isset($corriente->valor) ? $corriente->valor : " NO APLICA") }}</td>
      <td class=xl1526419></td>
    </tr> -->
    <!-- <tr height=21 style='height:15.75pt'>
      <td colspan=7 height=21 class=xl8226419 width=163 style='border-right:1.0pt solid black;
      ...
      <td colspan=22 class=xl8226419 width=189 style='border-right:1.0pt solid black;
					border-left:none;width:147pt'>&nbsp;{{ (isset($potencia->valor) ? $potencia->valor : " NO APLICA") }}</td>
      <td colspan=14 class=xl8226419 width=178 style='border-right:1.0pt solid black;
					border-left:none;width:135pt'>3.6 Rango de frecuencia [Hz]</td>
      <td colspan=11 class=xl8226419 width=222 style='border-right:1.0pt solid black;
					border-left:none;width:168pt'>&nbsp;{{ (isset($frecuencia->valor) ? $frecuencia->valor : " NO APLICA") }}</td>
      <td class=xl1526419></td>
    </tr> -->
    <!-- <tr height=21 style='height:15.75pt'>
      <td colspan=7 height=21 class=xl8226419 width=163 style='border-right:1.0pt solid black;
      ...
      <td colspan=22 class=xl8226419 width=189 style='border-right:1.0pt solid black;
					border-left:none;width:147pt'>&nbsp;{{ (isset($presion->valor) ? $presion->valor : " NO APLICA") }}</td>
      <td colspan=14 class=xl8226419 width=178 style='border-right:1.0pt solid black;
					border-left:none;width:135pt'>3.9 Rango de velocidad [m/s]</td>
      <td colspan=11 class=xl8226419 width=222 style='border-right:1.0pt solid black;
					border-left:none;width:168pt'>&nbsp;{{ (isset($velocidad->valor) ? $velocidad->valor : " NO APLICA") }}</td>
      <td class=xl1526419></td>
    </tr> -->
    <!-- <tr height=21 style='height:15.75pt'>
      ...
      <td colspan=15 class=xl8226419 width=159 style='border-right:1.0pt solid black;
					border-left:none;width:122pt'>&nbsp;{{ (isset($temperatura->valor) ? $temperatura->valor : " NO APLICA") }}</td>
      <td colspan=14 class=xl8226419 width=178 style='border-right:1.0pt solid black;
					border-left:none;width:135pt'>3.11 Rango de humedad %</td>
      <td colspan=11 class=xl8226419 width=222 style='border-right:1.0pt solid black;
					border-left:none;width:168pt'>&nbsp;{{ (isset($humedad->valor) ? $humedad->valor : " NO APLICA") }}</td>
      <td class=xl1526419></td>
    </tr> -->
    <tr height=21 style='height:15.75pt'>
        ...
        @if(isset($archivo))
          <ul>
            @foreach($archivo as $archivo_row)
              <li>Archivo: {{ $archivo_row->file }} <a style="color: #222d32;font-size:15px;font-weight:900;" href="{{ url('/') }}assets/upload_archivos/{{ $archivo_row->file }}" onclick="window.open(this.href, 'mywin',
    ...
    <tr height=21 style='height:15.75pt'>
      ...
      <td colspan=6 class=xl17226419 width=66 style='border-right:1.0pt solid black;
							width:51pt'>&nbsp;{{ $equipo->evaluacion_desempenio }}</td>
      ...
      <td colspan=6 class=xl11826419 width=72 style='border-right:1.0pt solid black;
							border-left:none;width:55pt'>&nbsp;{{ $equipo->calibracion }}</td>
    ...
    <tr height=22 style='height:16.5pt'>
      ...
      <td colspan=6 class=xl17826419 width=102 style='border-left:none;width:78pt'>M1:&nbsp;{{ $equipo->preventivo_mes1 }}</td>
      <td colspan=6 class=xl17826419 width=99 style='border-left:none;width:75pt'>M2:&nbsp;{{ $equipo->preventivo_mes2 }}</td>
      <td colspan=4 class=xl6626419 width=97 style='border-right:1.0pt solid black;
							border-left:none;width:73pt'>M3:&nbsp;{{ $equipo->preventivo_mes3 }}</td>
      <td class=xl1526419></td>
    </tr>
    <tr height=22 style='height:16.5pt'>
    ...
    <tr height=27 style='height:20.25pt'>
      ...
      <td colspan=26 class=xl20126419 width=259 style='border-right:.5pt solid black;
        ...
        @if($equipo->manual_id != 0)
          <strong>Url:</strong> &nbsp;
          <a target="__blank" href="{{ $equipo->manual_url }}">{{ $equipo->manual_url }}</a>
          <br>
          <strong>Descripción:</strong> &nbsp;
          {{ $equipo->manual_descripcion }}
        <?php endif ?>
      ...
      <td colspan=18 class=xl20126419 width=348 style='border-right:.5pt solid black;
							width:263pt'>&nbsp; @if(($equipo->plano != null) && ($equipo->plano != "N;"))
          <?php
    ...
    @if($equipo->tipo_id == 1)
      <tr height=23 style='height:17.25pt'>
        ...
        <td colspan=19 rowspan=2 class=xl19326419 width=195 style='border-right:.5pt solid black;
							border-bottom:.5pt solid black;width:149pt'>&nbsp;{{ $equipo->clasificaciones }}</td>
        ...
        <td colspan=7 rowspan=2 class=xl19026419 width=148 style='border-right:.5pt solid black;
							border-bottom:.5pt solid black;width:112pt'>&nbsp;{{ $equipo->criesgos }}</td>
        <td class=xl1526419></td>
      </tr>
      <tr height=21 style='height:15.75pt'>
    ...
    <tr height=21 style='height:15.75pt'>
      <td colspan=54 height=21 class=xl12726419 width=752 style='border-right:1.0pt solid black;
        ...
        <div class="row row-owner">
          ...
          <div class="col-sm-4">
            <img class="img-responsive" src="{{ url('/') }}assets/upload_imagenes/{{ $equipo->propietario_logo }}" alt="Logo del propietario">
          </div>
          @if($equipo->baja_id != 0)
            <div class="col-sm-4">
              <h5><u>Este equipo ha sido relacionado a inventaio para su correspondiente disposición final</u></h4>
                <small class="text-muted">{{ $equipo->baja_fecha }}</small>
                <strong>Descripcion del documento de disposición final:</strong><br>
                {{ $equipo->baja }}
                <a class="fa fa-paperclip" target="__blank" href="{{ url('/') }}assets/upload_bajas/{{ $equipo->baja_documento }}"></a>
            </div>
          <?php endif ?>
        </div>
      </td>
        ...
        <td colspan=54 height=22 class=xl12726419 width=752 style='border-right:1.0pt solid black;
          ...
          <ul>
            @foreach($archivos as $archivo_singular)
              <li>
                {{ $archivo_singular->archivo }}({{ $archivo_singular->otro }})<a target="__blank" class="glyphicon glyphicon-file esconder" href="{{ url('/'); }}assets/upload_equipo_archivos/{{ $archivo_singular->vinculo }}"></a>
              </li>
            <?php endforeach ?>
          </ul>
        </td>
    ...
    <?php endif ?>
    @if(($equipo->observacion != null && $equipo->observacion != "") || ((isset($observaciones)) && (!empty($observaciones))))
      <tr height=21 style='height:15.75pt'>
        <td colspan=54 height=21 class=xl7226419 width=752 style='border-right:1.0pt solid black;
        ...
        <td colspan=54 height=22 class=xl12726419 width=752 style='border-right:1.0pt solid black;
          ...
          @if(isset($observaciones))
            ...
            @foreach($observaciones as $observacion_row)
              @if($this->session->Userdata("rol_id") > 2 && $observacion_row->id == 557)
              @else
                <p> <strong>{{ $observacion_row->created_at }}</strong>
                  @if($observacion_row->file != null && $observacion_row->file != "")
                    <a href="{{ url('/'); }}assets/upload_observaciones/{{ $observacion_row->file }}" target="__blank" class="glyphicon glyphicon-file"></a>
                  <?php endif ?>
                  <br>
                  Usuario: {{ ($observacion_row->usuario != null && $observacion_row->usuario != "") ? $observacion_row->usuario : "No registra" }}
                  <br>
                  {{ $observacion_row->description }}
                </p>
                <span class="glyphicon glyphicon-wrench text-danger" title="Repuesto pendiente">{{ $observacion_row->repuesto_id }}</span>
