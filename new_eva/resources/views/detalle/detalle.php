				...
				<div class="tg-wrap"><table class="tg">
					...
					<tr>
						...
						<td class="tg-ng7p" colspan="5" rowspan="9">
							<img  class="" width="350px" height="280px" src="<?php echo base_url();?>assets/upload_imagenes/<?php echo $equipo->image;?>" alt="">
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="tg-0pky" colspan="4"><?php echo $equipo->invima; ?>
							<?php if ($equipo->archivo_invima!=null): ?>
								<a target="__blank" class="glyphicon glyphicon-file esconder" href="<?php echo base_url();?>assets/upload_invimas/<?php echo $equipo->archivo_invima;?>"></a>
		...
		<tr>
			<td class="tg-0pky" colspan="10" rowspan="3">
				<div class="col-sm-3 col-md-3">
					<?php if ($equipo->accesorios!=null&&$equipo->accesorios!=""): ?>
		...
		<tr>
			<td class="tg-0lax" colspan="10">
				<?php if ($equipo->observacion!=null&&$equipo->observacion!=""): ?>
			...
			<tr>
				<td class="tg-0lax" colspan="10">
					<table class="table table-bordered tblCorrectivos" >
						...
						<tbody>
							<?php foreach ($correctivos_original as $correctivo): ?>
								<tr>
									<td><?php echo $correctivo->id; ?></td>
									<td><?php echo $correctivo->descripcion; ?></td>
									<td><?php echo $correctivo->estado; ?></td>
									<td>
										<?php if ($correctivo->image!=""&&$correctivo->image!=null): ?>

											<a  target='_blank' href='<?php echo base_url();?>assets/upload_correctivos/<?= $correctivo->image;?>' class='btn bnt-info'><span class='glyphicon glyphicon-file'></span><br>

											<?php endif ?>
											<?php if ($correctivo->file_diagnostico!=""&&$correctivo->file_diagnostico!=null): ?>

												<a  target='_blank' href='<?php echo base_url();?>assets/upload_correctivos/<?= $correctivo->file_diagnostico;?>' class='btn bnt-info'><span class='glyphicon glyphicon-file'></span><br>
												<?php endif ?>

												<?php if ($correctivo->file_cierre!=""&&$correctivo->file_cierre!=null): ?>

													<a  target='_blank' href='<?php echo base_url();?>assets/upload_correctivos/<?= $correctivo->file_cierre;?>' class='btn bnt-info'><span class='glyphicon glyphicon-file'></span><br>
						...
						<tr>
							<td class="tg-0lax" colspan="10">
								<table class="table table-bordered tblCorrectivosGenerales" >
									...
									<tbody>
										<?php foreach ($correctivos_generales_original as $correctivo_general): ?>
											<tr>
												...
												<?php if ($correctivo_general->file!=""&&$correctivo_general->file!=null): ?>

													<td><a  target='_blank' href='<?php echo base_url();?>assets/upload_correctivos_generales/<?= $correctivo_general->file;?>' class='btn bnt-info'><span class='glyphicon glyphicon-file'></span></td>
												<?php endif ?>
											</tr>
						...
						<tr>
							<td class="tg-0lax" colspan="10">
								<table class="table table-bordered tblPreventivos" >
									...
									<tbody>
										<?php foreach ($preventivos_original as $preventivo): ?>
											<tr>
												...
												<?php if ($preventivo->file!=""&&$preventivo->file!=null): ?>

													<td><a  target='_blank' href='<?php echo base_url();?>assets/upload_preventivos/<?= $preventivo->file;?>' class='btn bnt-info'><span class='glyphicon glyphicon-file'></span></td>
												<?php endif ?>
											</tr>
						...
						<tr>
							<td class="tg-0lax" colspan="10">
								<table class="table table-bordered tblCalibraciones" >
									...
									<tbody>
										<?php foreach ($calibraciones_original as $calibracion): ?>
											<tr>
												...
												<?php if ($calibracion->file!=""&&$calibracion->file!=null): ?>

													<td><a  target='_blank' href='<?php echo base_url();?>assets/upload_calibraciones/<?= $calibracion->file;?>' class='btn bnt-info'><span class='glyphicon glyphicon-file'></span></td>
												<?php endif ?>
											</tr>
						...
						<tr>
							<td class="tg-0lax" colspan="10">
								<div class="text-center">
									<ul>
										<?php foreach ($archivos as $archivo_singular): ?>
											<li >
