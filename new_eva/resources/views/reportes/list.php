  ...
  <div class="row">
    ...
    <div class="col-lg-3 col-xs-6">
      ...
      <div class="small-box bg-green">
        <div class="inner">
          <h3><?php echo $incluidoPreventivo->total; ?><sup style="font-size: 20px"></sup></h3>
    ...
    <div class="col-lg-3 col-xs-6">
      ...
      <div class="small-box bg-yellow">
        <div class="inner">
          <h3><?php echo $obtenidosComodato->total; ?></h3>
    ...
    <div class="col-lg-3 col-xs-6">
      ...
      <div class="small-box bg-red">
        <div class="inner">
          <h3><?php echo $planNoComodato->total; ?></h3>
        ...
        <div class="box-body">
          <div class="table-responsive">
            <table class="table no-margin">
              ...
              <tbody>
                <?php foreach ($estadoOrdenes as $resumen): ?>
                  <tr>
                    <td><?php echo $resumen->estado; ?></td>
                    <td><?php echo $resumen->total; ?></td>
                  </tr>
                <?php endforeach ?>
              </tbody>
            </table>
    ...
    <div class="col-md-3">
      ...
      <div class="info-box bg-yellow">
        ...
        <div class="info-box-content">
          ...
          <span class="info-box-number" id="tiempo_promedio"><?php echo $PromedioTiempoTotal->total; ?> </span>(h)
        </div>
        <!-- /.info-box-content -->
      </div>
      <!-- /.info-box -->
      <div class="info-box bg-green">
        ...
        <div class="info-box-content">
          ...
          <span class="info-box-number" id="tiempo_menor"><?php echo $MenorTiempoTotal->total; ?> </span>(h)
        </div>
        <!-- /.info-box-content -->
      </div>
      <!-- /.info-box -->
      <div class="info-box bg-red">
        ...
        <div class="info-box-content">
          ...
          <span class="info-box-number" id="tiempo_mayor"><?php echo $MayorTiempoTotal->total; ?> </span>(h)
        </div>
        <!-- /.info-box-content -->
      </div>
      <!-- /.info-box -->
    ...
    <div class="col-sm-6 col-md-6 col-lg-6">
      ...
      <div class="row">
        ...
        <div class="col-sm-4 col-md-4 col-lg-4">
          <input class="form-control" type="date" id="fecha_cierre_inicio" name="fecha_cierre_inicio" value="<?php echo date("Y-m-d",strtotime('-360 day'));?>">
        </div>
        <div class="col-sm-2 col-md-2 col-lg-2">
          <label for="fecha_cierre_fin">Fecha final</label>
        </div>
        <div class="col-sm-4 col-md-4 col-lg-4">
          <input class="form-control" type="date" id="fecha_cierre_fin" name="fecha_cierre_fin" value="<?php echo date("Y-m-d",strtotime('+360 day'));?>">
        </div>
      </div>
      <div class="row">
        <div class="col-sm-12">
      ...
      <div class="row">
        ...
        <div class="col-sm-4 col-md-4 col-lg-4">
          <input class="form-control" type="date" id="fecha_creacion_inicio" name="fecha_creacion_inicio" value="<?php echo date("Y-m-d",strtotime('-360 day'));?>">
        </div>
        <div class="col-sm-2 col-md-2 col-lg-2">
          <label for="fecha_creacion_fin">Fecha final</label>
        </div>
        <div class="col-sm-4 col-md-4 col-lg-4">
          <input class="form-control" type="date" id="fecha_creacion_fin" name="fecha_creacion_fin" value="<?php echo date("Y-m-d",strtotime('+360 day'));?>">
        </div>
      </div>
      <div class="row">
        <div class="col-sm-12">
        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            <ul class="lista_consolidados list-group">  
              <li class="list-group-item"><a href="<?php echo base_url();?>equipo/Cequipos/ConsolidadoCorrectivos" target="_blank">Correctivos Tickets</a></li>          
              <li class="list-group-item"><a href="<?php echo base_url();?>equipo/Cequipos/ConsolidadoCorrectivosGenerales" target="_blank">Otros correctivos</a></li>          
              <li class="list-group-item"><a href="<?php echo base_url();?>equipo/Cequipos/ConsolidadoPreventivos" target="_blank">Preventivos</a></li>          
              <li class="list-group-item"><a href="<?php echo base_url();?>equipo/Cequipos/ConsolidadoCalibraciones" target="_blank">Calibraciones</a></li>          
            </ul>
          </div>
          <!-- /.box-body -->
          <div class="box-footer clearfix">
        ...
        <div class="box-body">
          <div class="table-responsive">
            <table class="table no-margin table-bordered">
              <tbody>
                <?php foreach ($cbiomedicas as $cbiomedica): ?>
                  <tr>
                    <td><?php echo $cbiomedica->cbiomedica; ?> <label class="badge"><?php echo $cbiomedica->total ?></label></td>
                  </tr>
                <?php endforeach ?>
              </tbody>
            </table>
      ...
      <div class="box box-info">
        ...
        <div class="box-body">
          <div class="table-responsive">
            <table class="table no-margin table-bordered">
              <tbody>
                <?php foreach ($criesgos as $criesgo): ?>
                  <tr>
                    <td class="text-center"><?php echo $criesgo->criesgo; ?> <label class="badge"><?php echo $criesgo->total ?></label></td>
                  </tr>
                <?php endforeach ?>
              </tbody>
            </table>
